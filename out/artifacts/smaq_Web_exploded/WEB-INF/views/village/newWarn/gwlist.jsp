...
<body>
  <nav class="breadcrumb">
    ...
    <c:if test="${not empty from && from == '1' }">
    	<a class="btn btn-success radius r" style="line-height: 1.6em;    margin-left: 10px; margin-top: 3px" href="${ly }/village/company/toGwCompanyList" title="返回">
    		返回
    	</a>
    </c:if>
...
<script type="text/javascript" src="${ly }/js/modules/newWarn/gwlist.js"></script>
