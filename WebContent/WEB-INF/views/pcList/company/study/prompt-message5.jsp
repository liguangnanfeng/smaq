...
<body>
	    ...
	    <span class="c-gray en">&gt;</span> <span>超时提示</span> 
    ...
    <div class="mt-20">
    	<table>
          <tr>
		     <td class="text-c" style="width:120px;height:280px;text-align:center;">
                <a  onClick="parent.close_tab(function(){})" style="font-size:40px;color:red;">请于规定时间，每日早晨10点前完成风险研判与承诺公告！</a>
            </td>
          </tr>
