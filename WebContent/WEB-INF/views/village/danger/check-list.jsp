...
<%--                                <c:if test="${be.c3 > 0}">--%>
<%--                                    <c:if test="${be.status != 2 || be.flag == 1}">--%>
<%--&lt;%&ndash;                                        <a style="text-decoration:none" onClick="show_dialog('复查详情_${be.id}', '${ly }/company/recheck-detail?checkId=${be.id }')" href="javascript:;">复查详情</a><br>&ndash;%&gt;--%>
<%--&lt;%&ndash;                                    &ndash;%&gt;--%>
