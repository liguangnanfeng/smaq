...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
    <form action="${ly }/company/tables/tab-jianglist" method="post">
        <div class="dis-ib">
          <span>资料类型：</span>
          <span class="select-box inline">
          <select name="isType" class="select">
            <option value="">全部</option>
            <option value="22" <c:if test="${22==isType}">selected</c:if>>安全责任制考核和奖惩台帐</option>
            <option value="23" <c:if test="${23==isType}">selected</c:if>>安全工作考核和奖惩台帐</option>
          </select>
          </span>
        </div>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <div class="l">
        <a class="btn btn-primary radius mt-5 mb-5"   href="${ly}/company/tables/templetDownload?isType=22"><i class="Hui-iconfont" style="font-size:15px;">&#xe640;</i> 查看安全责任制考核和奖惩台帐</a>
        <a class="btn btn-primary radius mt-5 mb-5"   href="${ly}/company/tables/templetDownload?isType=23"><i class="Hui-iconfont" style="font-size:15px;">&#xe640;</i> 查看安全工作考核和奖惩台帐</a>
      </div>
              ...
              <div class="row cl">
                ...
                <div class="formControls col-xs-8 col-sm-9" style="width:70%;">
                  <select name="isTab" id="b" class="select" style="height:31px;">
                    <option value="">全部</option>
                    <option value="22">安全责任制考核和奖惩台帐</option>
                    <option value="23">安全工作考核和奖惩台帐</option>
                  </select>
                </div> 
              </div>
