...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>添加区县</span> 
    ...
    <div class="win1" id="win3">
      <div class="tcall" style="min-height: 440px;position:relative">
        ...
        <div class="allsq" style="width:93%;max-height:340px;overflow-Y:auto;margin-left:7%;">
          ...
          <c:if test="${empty be.states}">
          <label class="dis-b" data-id="${be.userId }" data-rid="${be.regionId }" data-tid="${be.states }" data-n="${be.name }"><input type="checkbox" name="keyword" />${be.name }</label>
          </c:if>
          </c:forEach>
        </div>
