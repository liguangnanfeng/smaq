...
$(function(){
  ...
  $(".one_ocoms").click(function(){
    ...
    }else if($(this).html()=="全部镇"){
      $(this).closest(".div_coms").find("label").html("所在镇");
        ...
        <div class="div_mapleft">
         ...
         <div class="shan_companys">
           ...
           <div class="search_coms">
             <div class="div_coms" style="width:33%;">
             ...
             <div class="div_coms" style="width:33%">
               <div class="bt_coms" style="border-right:1px solid #ddd"><label>所在镇</label><i class="Hui-iconfont">&#xe6d5;</i></div>
               <div class="list_ocoms">
                 <div class="one_ocoms">全部镇</div>
                 <!-- 循环村 -->
                 <div class="one_ocoms">镇xx</div>
               </div>
             </div>
             <div class="div_coms" style="width:34%">
...
<script type="text/javascript">
    ...
    for (var i = 0; i < companyList.length; i++) {
        ...
        var color;
        var marker;
        if (companyList[i].dlevel == "红色") {
	        color = colorList[0];
	    } else if (companyList[i].dlevel == "橙色") {
	        color = colorList[1];
	    } else if (companyList[i].dlevel == "蓝色") {
	        color = colorList[2];
	    } else {
	        color = colorList[2];
	    }
