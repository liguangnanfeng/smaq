...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/fore/danger/danger-list" method="post">
        <div class="dis-ib">
          <span>品名：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('查看危险信息说明','${ly }/fore/danger/danger-show')"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 查看危险信息说明</a>
