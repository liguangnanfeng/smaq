...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>编辑村庄</span>  -->
    ...
    <form class="form form-horizontal">
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" id="userName" name="userName" value="${user.userName }" readOnly="readonly" placeholder="" style="width:350px" class="input-text required" maxlength="50" >
        </div> 
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2">村庄名称：</label>
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" id="villageName" name="villageName" value="${vi.name }" placeholder="" style="width:350px" class="input-text required" maxlength="50" >
        </div> 
      </div>
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          ...
          <input type="hidden" id="globalRegionId" value="${vi.regionId }">
        </div> 
      </div>
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          ...
          <textarea id="address"  class="textarea txtarea_sq" readonly="readonly" onclick="openmap()">${vi.address }</textarea>
        </div> 
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-2">村庄简介：</label>
        <div class="formControls col-xs-8 col-sm-9">
          <textarea id="accountNum" class="textarea txtarea_sq">${vi.accountnum }</textarea>
        </div> 
      </div>
      <div class="row cl">
    ...
    <div class="win1">
      <div class="tcall" style="min-height: 540px;">
        ...
        <div class="allsq" style="width:300px;margin-left:15px;">
          ...
          <input type="text" class="txt_sq" id="search" name="keyword" value="${vi.address }" style="width:210px;"/>
        </div>
