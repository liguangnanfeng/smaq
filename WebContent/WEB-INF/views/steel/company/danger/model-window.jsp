...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2" style="width:20%;text-align:right;">检查部位：</label>
      <div class="formControls col-xs-8 col-sm-9" style="width:70%;">
        <input type="text" id="name" value="${partN }" placeholder="根据检查需要填写或空缺" style="width:350px" class="input-text"/>
      </div> 
    </div>
    <div class="row cl">
...
<ul id="module" style="display: none;">
  <li class="item" data-n>
    <div class="title_item">
      <h4><b>+</b>部位名称xx</h4>
      <a class="btn_ejc" style="text-decoration:none" onclick="part_edit(this)" href="javascript:;" title="修改检查项">mm修改检查项</a>
