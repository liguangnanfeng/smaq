...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>信息接收列表</span> 
...
<script type="text/javascript" src="${ly }/js/modules/userGroup/reviceList.js"></script>
...
{@each list as m,index}
    <tr class="text-c">
          ...
          <td>$<{m.createName}></td>
          <td>$<{m.createTime}></td>
		  <td>{@if m.readFlag == 0}<span style="color:#ff0047">未读</span>
			 {@else}
				<span style="color:#666">已读</span>
			 {@/if}
		  </td>
          <td><a href="<c:url value='/village/messageDetail?messageId=$<{m.messageId}>&from=1'/>">查看详情</a>
