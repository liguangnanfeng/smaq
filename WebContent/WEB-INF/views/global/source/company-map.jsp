    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <input class="btn btn-primary radius" style="font-size: 16px;" type="button" value="测距" onClick="javascript:startRuler()" />
        </div>
        ...
        $http({
        method: 'POST',
        url: '${ly }/villageAdd/source/getCompanyByMap',
...
<%--    console.log(response.data.map.count);--%>
<%--    if(response.data.map.count===0){--%>
<%--    layer.alert("暂无该企业！");--%>
<%--    console.log('暂无该企业');--%>
<%--      }, function errorCallback(response) {--%>
...
<%--    &lt;%&ndash;    <script>&ndash;%&gt;--%>
<%--&lt;%&ndash;        // 创建两个点标记&ndash;%&gt;--%>
<%--&lt;%&ndash;        var m1 = new AMap.Marker({&ndash;%&gt;--%>
<%--&lt;%&ndash;        position: [116.49, 39.9]&ndash;%&gt;--%>
<%--&lt;%&ndash;        });&ndash;%&gt;--%>
<%--&lt;%&ndash;        var m2 = new AMap.Marker({&ndash;%&gt;--%>
<%--&lt;%&ndash;        position: [116.29, 39.9]&ndash;%&gt;--%>
<%--&lt;%&ndash;        });&ndash;%&gt;--%>
<%--&lt;%&ndash;        var m3 = new AMap.Marker({&ndash;%&gt;--%>
<%--&lt;%&ndash;        position: [116.69, 39.9],&ndash;%&gt;--%>
<%--&lt;%&ndash;        icon: "https://webapi.amap.com/theme/v1.3/markers/n/mark_r.png"&ndash;%&gt;--%>
<%--&lt;%&ndash;        });&ndash;%&gt;--%>

<%--&lt;%&ndash;        map.add(m1);&ndash;%&gt;--%>
<%--&lt;%&ndash;        map.add(m2);&ndash;%&gt;--%>
<%--&lt;%&ndash;        map.add(m3);&ndash;%&gt;--%>
<%--&lt;%&ndash;    </script>&ndash;%&gt;--%>
<%--<script>--%>
