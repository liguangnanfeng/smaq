...
<div class="page-container">
    <div class="div_pdetail">
        ...
        <c:if test="${listM.c > 0 && listM.status == 2 }">
            ...
            <c:if test="${number > 0}">
                <button onClick="show_dialog('整改详情','/global/check-rectification?flag=${flag}&id=${listM.id}&number=${number}&uid=${uid}')"
            ...
            <c:if test="${listM.c3 > 0}">
                <button onClick="show_dialog('整改复查意见书','/global/recheck-detail?checkId=${listM.id }&flag=${flag}&number=${number}')"
            ...
            <c:if test="${flag==2  }">
                ...
                <button onClick="show_dialog('检查文书','/global/check-document?checkId=${check.id }&uid=${uid}')"
        ...
        <c:if test="${latitude!=null&&longitude!=null}">
            <button onClick="location.href = '/village/loadMap?latitude=${latitude}&longitude=${longitude}&checkId=${check.id }&uid=${uid}'"
