...
<div>&nbsp;</div>
	...
	<div id="play_window_container" class="easyui-panel" style="text-align:center;margin:0 auto;width:100%;height:630px;border:0px solid red;overflow:hidden;padding-left:250px"></div>
...
function load_windows(num){
    ...
    switch (num) {
        ...
        case 9:
        	for (var i = 0; i < num; i++) {
        		var tail="";
        		if(i%3==2) tail = "</br></br></br></br></br></br></br></br></br></br></br>";
                htmlArray.push(
                	"<div style=\"float:right;width:10px;height:10px;display:inline;\"></div>",
                    "<div id=\"wnd" + i + "\" class=\"windowbox\">",
                    "<div id=\"windowbox" + i + "\" class=\"wnd\">",
                    "</div>",
                    "<div id=\"windowtitle" + i + "\" class=\"windowtitle\"><div id=\"title" + i + "\" class=\"title1\" >视频"+(i+1)+"</div><div  class=\"title2\"></div></div>",
                    "</div>"+tail
                );
            }
            break;
