    ...
    <form class="form form-horizontal" id="form">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="title" value="${companyname }企业定期检查表" style="width:350px" class="input-text" maxlength="50" placeholder="根据检查需要填写或空缺"/>
            </div>
        </div>
            <%--部门--%>
            <div class="row cl">
            ...
            <span class="select-box inline">
                   ...
                   <select name="departmentId" class="select" id="departmentId" value="" >
            ...
            <span class="select-box inline">
                   ...
                   <select name="department2Id" class="select" id="department2Id" value="" >
                             <option value="0">请选择岗位</option>
                       <c:if test="${ not empty  departmentName}">

                           <c:forEach items="${map}" var="entry"   >
                               <option value="${entry[departmentName]}">${entry[departmentName]}</option>
                           </c:forEach>
                       </c:if>
                       <%--  <c:if test="${ not empty  departmentName}">
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                ...
                <input type="radio" name="open" value="0" class="ml-20" <c:if test="${model.open == 0}">checked="checked"</c:if>/>关闭
        ...
        <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="cycle" value="" style="width:350px" class="input-text required ll-numberbox" data-options="min:1,max:365"/>
            </div>
        </div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-2">检查开始日期：</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" id="nextTime" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd', minDate:'%y-%M-{%d+1}'})" class="input-text Wdate mb-5 mt-5" style="width:350px;"/>
            </div>
        </div>
        <%-- <div class="row cl">
        ...
        <div class="row cl">
                        ...
                        <div class="info">
                            <table class="table table-border table-bordered table-bg table-hover table-sort">
                                ...
                                <c:forEach items="${items}" var="l">
                                    ...
                                    <tr class="text-c" data-lid="${l.dmid }"> <!--fix a bug id->dmid zhangcl 2018.12.13-->
                                        <td>${x}</td>
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-9 col-xs-offset-4 col-sm-offset-2  mt-20">
                    <button onClick="article_save_submit_1()" class="btn btn-primary radius" type="button" style="padding: 0 70px;">
                        <i class="Hui-iconfont">&#xe632;</i>保存检查表
                    </button>
                    <button onClick="giveup_save_submit()" class="btn btn-primary radius" type="button" style="padding: 0 70px;">
                        放弃添加
                    </button>
                </div>
            </div>
