...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/village/company/company-list-zg?cisDanger=1" method="post">
        <div class="dis-ib">
        <span>企业名称：</span>
      ...
      <table class="table table-border table-bordered table-bg table-hover table-sort">
        <thead>
          <tr class="text-c">
            <th width="5%">序号</th>
            <th width="15%">企业名称</th>
            <th width="20%">构成重大危险源的主要物质</th>
            <th width="20%">最大储存量</th>
            <th width="20%">使用/储存装置</th>
            <th width="20%">危险等级</th>
          </tr>
        </thead>
        <tbody>
          ...
          <tr class="text-c">
            ...
            <td>${se.name}</td>
            <td>
            <c:forEach items="${se.dangerMaterials }" var="be">
              <c:set var="danger" value="${fn:split(be, '/')}" />
              ${danger[0]}<br>
            </c:forEach> 
            </td>
            <td>
