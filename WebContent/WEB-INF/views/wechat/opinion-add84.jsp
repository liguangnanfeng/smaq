...
<div class="container">
  ...
  <div class="row cl mb-20">
        ...
        <p class="MsoNormal" style="text-align:center;margin-top:10px;" align="center">
            <span style="font-size:14.7pt;"><span contenteditable="true">（&nbsp;&nbsp;&nbsp;）</span><span>安监现记〔督〕</span><span contenteditable="true">&nbsp;&nbsp;&nbsp;</span> <span>号</span></span>
        </p>
        <p class="MsoNormal" style="text-align:left;margin-top:30px">
            <span style="vertical-align: bottom;"><span>被检查单位：</span></span>
            <u><span style="border-bottom:1px solid #333;width:81%;display:inline-block;vertical-align: text-bottom;" contenteditable="true">&nbsp;${company.name }</span></u>
        </p>
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>地&emsp;&emsp;&emsp;址：</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:81%;display:inline-block;" contenteditable="true">&nbsp;${company.address }</span></u>
        </p>
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>法定代表人：</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:18%;display:inline-block;" contenteditable="true">&nbsp;${company.legal }</span></u>
        ...
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>检查场所及内容：</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:76%;display:inline-block;" contenteditable="true">&nbsp;</span></u>
        </p>
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>检查时间</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:8%;display:inline-block;text-align:center;" contenteditable="true">&nbsp;<fmt:formatDate value="${timenow }" pattern="yyyy"/></span></u>
            <span style="vertical-align: bottom;"><span>年</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:5%;display:inline-block;text-align:center;" contenteditable="true">&nbsp;<fmt:formatDate value="${timenow }" pattern="MM"/></span></u>
            <span style="vertical-align: bottom;"><span>月</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:5%;display:inline-block;text-align:center;" contenteditable="true">&nbsp;<fmt:formatDate value="${timenow }" pattern="dd"/></span></u>
            <span style="vertical-align: bottom;"><span>日</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;;width:5%;display:inline-block;text-align:center;" contenteditable="true">&nbsp;</span></u>
        ...
        <p class="MsoNormal" style="text-indent:23.0000pt;text-align:left;">
            ...
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom; width:18%;display:inline-block;text-indent: 0;" contenteditable="true">&nbsp;无锡市惠山区</span></u>
            <span style="vertical-align: bottom;"><span>安全生产监督管理局行政执法人员</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom; width:21%;display:inline-block;text-indent: 0;" contenteditable="true">&nbsp;</span></u>
    ...
    <p class="MsoNormal" style="border-top:1px solid #000;text-align:right;">
        ...
        <div id="div_model">
            <p class="MsoNormal" style="text-indent:21.0000pt;" >
                <span class="num_dan" style="">1</span><span style="">．</span><u><span contenteditable="true" style="text-decoration:underline;text-indent: 0;" class="yh_span">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></u></u>
                <i class="Hui-iconfont mr-10 dustbin" style="cursor:pointer;font-size:20px" onclick="removeDan(this)">&#xe609;</i>
            </p>
        </div>
     <!-- 底部操作 -->
