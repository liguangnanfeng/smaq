    ...
    function save_() {
      $.post(getRootPath() + "/global/danger/opinion-save", {
          ...
          flag2 : 2
        	...
        	window.location.href = getRootPath() + "/global/danger/opinion-detail?uid=${uid}&id="+reuslt.data.id;
      })
  	}  
    </script>
</head>
...
<body>
    <div class="page-container" style="width:150mm;margin:auto;padding:10px 0 0 0;">
        ...
        <p class="dant1" style="text-align:center;border-top:1px solid #000;margin-bottom:3px;" align="center">
            <span></span><b><span style="font-family:华文中宋;font-weight:bold;font-size:18pt;"><span>行政处罚决定书（单位）</span></span></b><b><span style="font-family:华文中宋;font-weight:bold;font-size:18.0000pt;"></span></b>
        </p>
        ...
        <p class="MsoNormal" style="text-align:left;">
            ...
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;width:56%;display:inline-block;" contenteditable="true">&nbsp;${company.address }</span></u>
            <span style="vertical-align: bottom;"><span>邮政编码：</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;width:17%;display:inline-block;" contenteditable="true">&nbsp;${company.postage }</span></u>
        </p>
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>法定代表人（负责人）：</span></span>
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;width:13%;display:inline-block;" contenteditable="true">&nbsp;${company.legal }</span></u>
        ...
        <p class="MsoNormal" style="text-align:left;">
            ...
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;width:48%;display:inline-block;" contenteditable="true">&nbsp;</span></u>
            <span style="vertical-align: bottom;"><span>申请行政复议，或者在6个月内依</span></span>
        </p>
        <p class="MsoNormal" style="text-align:left;">
            <span style="vertical-align: bottom;"><span>法向</span></span>
            ...
            <span style="vertical-align: bottom;"><span>人民法院提起行政诉讼，但本决定不停止执行，法</span></span>
        </p>
        <p class="MsoNormal" style="text-align:left;line-height:30px">
            <span style="vertical-align: bottom;"><span>律另有规定的除外。逾期不申请行政复议、不提起行政诉讼又不履行的，本机关将依法申请人民法院强制执行或者依照有关规定强制执行。</span></span>
        </p>
