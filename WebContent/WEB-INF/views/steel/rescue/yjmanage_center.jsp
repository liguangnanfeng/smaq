...
<%--            margin-left: 9%;--%>
        ...
        <main>
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a class="one_tx radius pos-r aa"  data-title="重点部位" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="/village/to_monitor-list?flag=1" style="background:#1450DD;" >
            ...
            <c:choose>
                ...
                <c:otherwise>
                    <a class="one_tx radius pos-r aa"  data-title="关键装置" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="/village/to_monitor-list?flag=2" style="background:#1450DD;" >
                    <font style="width: 95%;text-align: center;left:auto;" class="font_tx1 pos-a "></font>
