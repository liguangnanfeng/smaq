...
<%--  show_dialog("隐患数据分析", getRootPath() + "/village/danger-collect-print?" + obj);--%>
<%--}--%>
<%--</script>--%>
<%--</head>--%>
<%--<body>--%>
...
<%--    <div class="text-c">--%>
<%--      <form action="${ly }/village/danger-collect" method="post">--%>
...
<%--    </c:forEach>--%>
<%--   <!--  <div class="cl pd-5 bg-1 bk-gray mt-20"> -->--%>
<%--      &lt;%&ndash; <span class="l">共有<strong>${fn:length(list) }</strong> 家企业存在隐患；</span> --%>
...
<%--      <span class="l">重大隐患<strong>${d}</strong> 条；</span> &ndash;%&gt;--%>
<%--      --%>
...
<%--      </c:forEach>--%>
<%--      --%>
<%--      &lt;%&ndash; <span class="l">化工企业（危险化学品生产、经营、使用）、加油站<strong>${hg}</strong> 条；</span>--%>
<%--      <span class="l">工贸企业<strong>${yb}</strong> 条；</span> &ndash;%&gt;--%>
<%--    <!-- </div> -->--%>
<%--    <div class="mt-20" >--%>
...
<%--             &lt;%&ndash;  <span>已整改：${be[3] + be[7] + be[11] + be[15]}</span>--%>
...
<%--              <span>未整改：${be[4] + be[8] + be[12] + be[16]}</span> &ndash;%&gt;--%>
<%--            </td>--%>
<%--            <td>--%>
...
<%--              &lt;%&ndash; <a href="${ly }/village/danger-index-list?flag=1&cId=${be[0]}&status=3">已整改：${be[3]}</a>--%>
...
<%--              <a href="${ly }/village/danger-index-list?flag=1&cId=${be[0]}&d=1&status=2">未整改：${be[4]}</a> &ndash;%&gt;--%>
<%--            </td>--%>
<%--            <td>--%>
...
<%--              &lt;%&ndash; <a href="${ly }/village/danger-index-list?flag=2&cId=${be[0]}&status=3">已整改：${be[7]}</a>--%>
...
<%--              <a href="${ly }/village/danger-index-list?flag=2&cId=${be[0]}&d=1&status=2">未整改：${be[8]}</a> &ndash;%&gt;--%>
<%--            </td>--%>
<%--            <td>--%>
...
<%--              &lt;%&ndash; <a href="${ly }/village/danger-index-list?flag=3&cId=${be[0]}&status=3">已整改：${be[11]}</a>--%>
...
<%--              <a href="${ly }/village/danger-index-list?flag=3&cId=${be[0]}&d=1&status=2">未整改：${be[12]}</a> &ndash;%&gt;--%>
<%--            </td>--%>
<%--            <td>--%>
...
<%--              &lt;%&ndash; <a href="${ly }/village/danger-index-list?flag=4&cId=${be[0]}&status=3">已整改：${be[15]}</a>--%>
...
<%--              <a href="${ly }/village/danger-index-list?flag=4&cId=${be[0]}&d=1&status=2">未整改：${be[16]}</a> &ndash;%&gt;--%>
<%--            </td>--%>
<%--          </c:forEach>--%>
<%--          <!-- 循环结束 -->--%>
<%--        </tbody>--%>
