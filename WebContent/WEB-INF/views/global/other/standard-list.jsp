    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <div style="display:flex; justify-content:  center;position: relative; top: 18px;">
        <input type="text"  id="name" class="input-text mb-5 mt-5" style="width:150px;margin-right:15px">
        <button id="search" class="btn btn-success mb-5 mt-5" type="submit">
