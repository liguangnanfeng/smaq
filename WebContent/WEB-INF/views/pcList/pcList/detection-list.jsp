...
<body>
  ...
  <div class="tabBar clearfix">
    ...
    <a style="border-radius:0 5px 5px 0;" href="${ly }/town/cx/warning/examination-list?isTime=${isTime}&villageId=${villageId }&townId=${townId }&districtId=${districtId }">职业健康体检</a>
  </div>
    <div class="page-container">
      <div class="text-c">
        <form action="${ly }/town/cx/warning/detection-list?villageId=${villageId }&townId=${townId }&districtId=${districtId }" method="post">
          <div class="dis-ib">
            <span>所属企业：</span>
