                        ...
                        <tr class="text-c">
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=5&industryType=-2')"
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=1&industryType=-2')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=2&industryType=-2')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=3&industryType=-2')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=4&industryType=-2')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort">
                    ...
                    <c:forEach items="${jiChuItem}" varStatus="index" var="be">
                        <tr class="text-c">
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=5&industryType=-1')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=1&industryType=-1')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=2&industryType=-1')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=3&industryType=-1')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
...
<%--                                   href="javascript:;">实施</a>--%>
                            ...
                            <td>
                                <a style="text-decoration:none"
                                   onClick="show_dialog('生成检查表', '${ly}/village/model-add5?dmname=${be.level1 }&dmid=${be.dmid }&checkType=4&industryType=-1')"
                                   href="javascript:;">设置</a>
<%--                                <a style="text-decoration:none"--%>
