...
(function ($) {
    ...
    class PicSign {
        ...
        domadd(signdata) {
            var $this = this;
            if (signdata) {
            	//console.log("zhangcl : "+$this.Options.signclass);
            	//alert("zhangcl : "+$this.Options.signclass);
                ...
                //同步显示 zhangcl 2019.3.20 多class无法同时显示bug
                //$this.domget().hide();
                //setTimeout(function () {
                //    $this.domget().show();
                //}, 10);
                ...
                if (sign) {
                    if (!isadd) {
                        ...
                        sign.webuiPopover($.extend({}, webuiPopoverSetting, {
                            title: "信息" + signbtn.prop("outerHTML"),
        ...
        //改变标注样式
        changesignclass(signclass) {
        	//alert(signclass);
            this.Options.signclass = signclass;
        }
    }
})(jQuery);