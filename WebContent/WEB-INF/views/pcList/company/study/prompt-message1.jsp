...
/* 弹窗工具添加 */
function addgj() {
  window.location.href = "/company/study/naturaldanger-list";
}
...
<body>
	    ...
	    <span class="c-gray en">&gt;</span> <span>固有风险研判提示</span> 
    	...
    	<table>
          <tr>
		     <td class="text-c" style="width:60px;height: 90px;text-align:center;">
                <button class="btn btn-primary radius" onClick="addgj()">请先进行固有风险研判流程</button>
            </td>
          </tr>
