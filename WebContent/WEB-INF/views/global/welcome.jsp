    ...
    <div class="div_tx">
      ...
      <div class="div_company">
        ...
        <span style="margin-top:10px">
            <a data-href="${ly }/village/company/company-map" data-title="企业分布图" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">企业分布图<img alt="" src="${ly }/images/fore/fb.jpg"/></a>
          </span>
      </div>
    ...
    <div class="mt-15 pos-r">
      ...
      <div class="div_tx div_yh pos-a" style="height:313px;padding: 13px 20px 0px;">
        ...
        <div class="list_zd">
          ...
          <a class="one_tx radius pos-r"  data-title="重大危险源隐患企业列表" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/toZdCompanyList?hazard=1" style="width:100%;margin-right:0;background:#1450DD;" >
          ...
          <a class="one_tx radius pos-r"  data-title="有限（受限）空间作业" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/toGwCompanyList?danger=1" style="width:100%;margin-right:0;background:#1450DD;" >
...
<div style="position: fixed;right:10px;top:0px;width:15%">
  <c:if test="${userType==10||userType==6}">
  ...
  <c:if test="${userType==10||userType==4||userType==3||userType==9}">
  <div class="panel panel-default" style="width:100%;margin-right:10px;float:right;margin-top:15px;">
    <div class="panel-body" style="padding:8px">
