...
<body>
  ...
  <div class="page-container">
    <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;">
        <a class="btn default ${flag == 1 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/danger-index-list?flag=1&cId=${cId}&villageId=${villageId }&townId=${townId }&districtId=${districtId }">企业自查</a>
        <a class="btn default ${flag == 4 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/danger-index-list?flag=4&cId=${cId}&villageId=${villageId }&townId=${townId }&districtId=${districtId }">行政检查</a>
        <a class="btn default ${flag == 3 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/danger-index-list?flag=3&cId=${cId}&villageId=${villageId }&townId=${townId }&districtId=${districtId }">部门抽查</a>
        <a class="btn default ${flag == 2 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/danger-index-list?flag=2&cId=${cId}&villageId=${villageId }&townId=${townId }&districtId=${districtId }">执法检查</a>
    </div>
    <div class="text-c">
      <form action="${ly }/town/cx/danger-index-list?flag=${flag}&cId=${cId}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" method="post">
        <%-- <div class="dis-ib">
          <span>部位名称：</span>
