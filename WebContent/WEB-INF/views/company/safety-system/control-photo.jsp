...
<div>
    <div class="row cl mt-15">
        ...
        <label class="form-label col-xs-4 col-sm-2" style="width:6%;text-align:right;">名称：</label>
        <div class="formControls col-xs-8 col-sm-9" style="width:300px;">
            <span class="btn-upload form-group">
...
<script type="text/javascript">
    ...
    function upload() {
        ...
        $.ajaxFileUpload({
            url: getRootPath() + '/company/safety-system/save-photo?name='+name, //用于文件上传的服务器端请求地址
