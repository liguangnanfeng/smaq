    ...
    <div class="div_pdetail" style="margin-bottom:30px;margin-top:15px;">
        <c:choose>
            <c:when test="${check.flag == 1}">
                <button onClick="javascript:show_dialog('检查表打印', '/company/print-recheck-detail?checkId=${check.id}')"
                        class="btn btn-success radius" type="button" style="padding: 0 60px;margin-right: 20px">
                    <i class="Hui-iconfont mr-10">&#xe652;</i>打印预览
                </button>
            </c:when>
            <c:otherwise>
                <button onClick="javascript:show_dialog('复查意见书', '/village/check-document?checkId=${check.id}&flag=2')"
                        class="btn btn-success radius" type="button" style="padding: 0 60px;margin-right: 20px">
                    ...
                    <td colspan="6">
                        ...
                        <div class="div_pri">
                            ...
                            <c:forEach items="${itemList }" var="be">
                                <c:if test="${be.recheckId == p.id}">
                                    <c:set value="${ind + 1}" var="ind"/>
                                    <div class="check-box">
                                        <input type="checkbox" name="isli" data-i="" disabled="disabled" <c:if
                                                test="${be.status == 3}"> checked</c:if>/>
                                        <label>${ind }</label>
                                    </div>
                                </c:if>
                            </c:forEach>
                        ...
                        <div class="div_pri  mb-10  mt-10">
                            ...
                            <input type="text" id="planTime"
                                   value="<fmt:formatDate value="${p.nextTime }" pattern="yyyy-MM-dd"/>"
                ...
                <tr>
                        ...
                        <div style="float:left;width:100%;position: relative;min-height:150px;">
                            ...
                            <c:if test="${check.flag > 1}">
                                ...
                                <div class="div_pright  mt-10 mb-10">
                                    <input type="text" style="width:150px" id="checkCompany"
                                           value="${check.checkCompany }" class="input-text" maxlength="50"
                                           disabled="disabled"/>
                                </div>
                                <br/>
                            </c:if>
                            ...
                            <div class="div_pright  mt-10 mb-10">
                                <input type="text" style="width:150px" value="${p.checker }" class="input-text"
                    ...
                    <td colspan="3">
                        <div style="float:left;width:100%;min-height:150px;">
                            ...
                            <div class="div_pright  mt-10 mb-10">
                                <input type="text" style="width:150px" value="${check.dapartContact }"
