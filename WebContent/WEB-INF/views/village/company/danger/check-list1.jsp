          ...
          <c:forEach items="${list }" varStatus="index" var="be">
            ...
            <td>
              ...
              <c:choose>
                ...
                <c:if test="${jcxq != 1 }">
                	<c:if test="${be.status != 2 || be.flag == 1 }">
                     <a style="text-decoration:none" onClick="show_dialog('检查详情_${be.id }', '${ly}/company/check-detail?flag=${flag }&id=${be.id }')" href="javascript:;">检查详情ggggggg</a><br>
                	</c:if>
                </c:if>
                <c:if test="${jcxq == 1 }">
                	<a style="text-decoration:none" onClick="show_dialog('检查详情_${be.id }', '${ly}/company/check-detail?jcxq=1&flag=${flag }&id=${be.id }')" href="javascript:;">检查详情_zzzzzzzzz</a><br>
                </c:if>
                     <%-- <c:if test="${flag == 1 }">
