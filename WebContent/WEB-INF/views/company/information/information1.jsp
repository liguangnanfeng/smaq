...
<body>
  ...
  <div class="page-container">
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('修改基本信息','${ly }/company/basic-information-change')"<%-- data-title="修改基本信息" data-href="${ly }/company/basic-information-change" onclick="Hui_admin_tab(this)" href="javascript:;" --%>><i class="Hui-iconfont" style="font-size:15px;">&#xe6df;</i> 修改基本信息</a>
...
<script>
  $(function () {
    $("#hazard").change(function () {
        var value = $(this).val();
        $.ajax({
          "url":"${ly}/company/updateHazard?hazard="+value,
          "success":function(){
            alert("修改成功");
          },
          "error":function(){
