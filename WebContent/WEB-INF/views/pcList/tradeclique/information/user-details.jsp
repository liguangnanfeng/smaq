...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span>  部门人员
    <span class="c-gray en">&gt;</span>  人员详情
    <!-- <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="javascript:location.replace(location.href);" title="刷新">
    <i class="Hui-iconfont">&#xe68f;</i></a> -->
    <a class="btn btn-success radius r" style="line-height: 1.6em; margin-top: 3px" href="${ly }/tradeclique/information/user-list" title="返回">返回</a>
  </nav>
  <div class="page-container">
    <div class="text-c div-search">
      <form action="${ly }/tradeclique/information/user-details?userId=${userId}" method="post">
...
function showadd(id){
  show_dialog("部门人员", '/tradeclique/information/user-add?userId=${userId}&id=' + id);
}

function del_(id) {
  layer.confirm("确认要删除该数据么？", function(index) {
    $.post("/tradeclique/information/user-save", {
      id : id,
      del : 1
    },function(result) {
      layer.close(index);
