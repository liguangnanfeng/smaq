...
<div class="container">
  ...
  <div class="row cl mb-20">
        ...
        <div id="div_dangerm">
            <c:forEach items="${itemL }" var="be" varStatus="index">
                <p class="MsoNormal" style="text-indent:21.0000pt;">
                    <span style="">${index.index + 1}．</span><u><span style="font-family:'\4EFF\5B8B_GB2312';text-decoration:underline;text-indent: 0;" contenteditable="true">&nbsp;${be.memo }</span></u><u><span style="font-family:'\4EFF\5B8B_GB2312';text-decoration:underline;text-indent: 0;"></span></u> 
                </p>
            </c:forEach>
        </div>
        <p class="MsoNormal" style="margin-top:30px">
        ...
        <p class="MsoNormal" style="text-align:right;margin-top:15px">
            <span style=""><span contenteditable="true">&nbsp;<fmt:formatDate value="${timenow }" pattern="yyyy"/></span> 年&nbsp;&nbsp;<span contenteditable="true">&nbsp;&nbsp;</span> 月&nbsp;&nbsp;<span contenteditable="true">&nbsp;&nbsp;</span>日</span><span style=""></span>
        </p>
