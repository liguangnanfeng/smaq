...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>编辑乡镇</span>  -->
  ...
  <div class="page-container">
    <form class="form form-horizontal">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="text" id="townName" name="townName" value="${town.name }" placeholder="" style="width:350px" class="input-text required" maxlength="50" >
        </div> 
      </div>
      <div class="row cl">
      ...
      <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
          <input type="hidden" id="globalRegionId" value="${town.regionId }">
          <input type="hidden" id="jw" value="<c:if test="${!empty user.longitude}">${user.longitude },${user.latitude }</c:if>">
          <textarea id="address" class="textarea txtarea_sq" readonly="readonly" onclick="openmap()">${town.address }</textarea>
        </div> 
      </div>
      <div class="row cl">
    ...
    <div class="win1" id="win2">
      <div class="tcall" style="min-height: 540px;">
        ...
        <div class="allsq" style="width:300px;margin-left:15px;">
          ...
          <input type="text" class="txt_sq" id="search" name="keyword" value="${town.address }" style="width:210px;"/>
        </div>
    ...
    <div class="win1" id="win3">
      <div class="tcall" style="min-height: 440px;position:relative">
        ...
        <div class="allsq" style="width:93%;max-height:340px;overflow-Y:auto;margin-left:7%;">
          ...
          <c:if test="${empty be.townId or be.townId == town.userId}">
