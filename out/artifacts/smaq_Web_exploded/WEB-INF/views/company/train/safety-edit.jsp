  ...
  <form class="form form-horizontal" id="form">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="a" name="" value="${sa.name }" style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <option value="" >请选择</option>
          <c:forEach items="${list }" varStatus="index" var="saf">
			<option value="${saf.name }" 
			<c:if test="${sa.type eq saf.name}">selected</c:if>>${saf.name }</option>
		  </c:forEach>
        </select>
      </div> 
    </div>
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="b" name="" value="${sa.certificateNumber }" style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">取证时间：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input id="c" type="text" value="${sa.forensicTime }" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" name="safeTime1" class="input-text Wdate mb-5 mt-5" style="width:350px;">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">下次复审时间：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input id="e" type="text" value="${sa.reviewTime }" onfocus="WdatePicker({dateFmt:'yyyy-MM'})" name="safeTime3" class="input-text Wdate mb-5 mt-5" style="width:350px;">
      </div>
    </div>
      <label class="form-label col-xs-4 col-sm-2">备注：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <textarea id="f"  class="textarea txtarea_sq">${sa.remark }</textarea>
      </div> 
    <div class="row cl">
