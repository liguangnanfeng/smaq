...
<script type="text/javascript" src="${ly }/js/modules/newWarn/zdCompanyList.js"></script>
...
{@each list as m,index}
    <tr class="text-c">
          ...
          <td>$<{m.companyName}></td>
          <td>$<{m.warnCount}></td>
          <td><a class=""  data-title="$<{m.companyName}>重大危险源" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/zdlist?from=1&companyId=$<{m.companyId}>">查看详情</a></td>
     </tr>
{@/each}
</script>
</body>
