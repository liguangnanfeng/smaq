...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>重大危险源辨识物质目录</span> 
  ...
  <div class="page-container">
    <div class="mt-20" style="position: relative;">
      <table class="table table-border table-bordered table-bg table-hover table-sort" style="width:45%;">
        <thead>
          <tr class="text-c">
            <th width="10%">序号</th>
            <th width="30%">类别</th>
      ...
      <table class="table table-border table-bordered table-bg table-hover table-sort" style="width:45%;position: absolute;right:5%;top:0">
        <thead>
          <tr class="text-c">
            <th width="35%">类别</th>
