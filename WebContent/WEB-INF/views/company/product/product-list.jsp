...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>生产工艺</span>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/company/product/product-list" method="post">
        <div class="dis-ib">
          <span>产品名称：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('添加主要生产产品','${ly }/company/product/product-add')"<%-- data-title="添加主要生产产品" data-href="${ly }/company/product/product-add" onclick="Hui_admin_tab(this)" href="javascript:;" --%>><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加主要生产产品</a>
      </span>

      <span class="l isAll">
         <button class="btn btn-success radius ml-10" type="button" onclick="sequipmentImportBoxShow()">批量导入主要产品</button>
         <a class="btn btn-success" href="${ly}/company/downloadall?filename=人员模板.xlsx&fileurl=${ly}/upload/product.xlsx">批量导入模板</a>
      </span>
...
function admin_edit(id){
  show_tab("编辑主要生产产品", getRootPath() + "/company/product/product-edit?id=" + id);
}
...
function sequipmentImportSave() {
    ...
    $.ajaxFileUpload({
        url: getRootPath() + '/company/mainProductExcel',
...
/*删除*/
function del(id){
  $.post(getRootPath()+"/company/product/deleteProduct",{
    id:id,
  },function(reuslt){
    location.reload()
  })
...
// /*查询*/
//  function inquriy(){
//    $.post(getRootPath()+"/company/product/pr-inquriy",{
//      productName:$("#prName").val(),
//    },function(reuslt){
//      location.reload()
//    })
// }
