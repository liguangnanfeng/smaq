    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <c:if test="${leftBasic == 1}">
            ...
            <script>
            function sub1(){
            $("#iframe").attr("src", "/company/system/department-list");
            }
            function sub2(){
        ...
        <c:if test="${leftBasic == 5}">
            ...
            <iframe  onload="loadFrame()" scrolling="no" id="iframe" frameborder="0" width="100%" height="700px" src="${ly }/company/study/management-guide"></iframe>
        </c:if>
        <!--流程管理-->
        <c:if test="${leftBasic == 6}">
            ...
            <iframe src="${ly }/company/study/select?type=1"  onload="loadFrame()" scrolling="no" id="iframe" frameborder="0" width="100%" height="700px" ></iframe>
            <script>
            function sub1(){
        ...
        <c:if test="${leftBasic == 9}">
            ...
            <iframe src="${ly }/company/tables/tab-taizhang"  onload="loadFrame()" scrolling="no" id="iframe" frameborder="0" width="100%" height="700px" ></iframe>
            <script>
            function sub1(){
...
<%--        display:flex;--%>
<%--        justify-content: center;--%>
<%--        &lt;%&ndash;        background: #efefef;&ndash;%&gt;--%>
<%--        }--%>
<%--        ul li{--%>
<%--        display: inline-block;--%>
<%--        list-style-type: none;--%>
<%--        &lt;%&ndash;        border-right: 1px solid #efefef;&ndash;%&gt;--%>
<%--        text-align: center;--%>
<%--        padding: 10px 20px;--%>
<%--		margin-left: 12px;--%>
<%--        height: 4.2vw;--%>
...
<%--            &lt;%&ndash;<li><a href="${ly }/company/tables/tab-list?isType=1" data-title="安全生产规章制度"--%>
...
<%--            &lt;%&ndash;<div class="div_otop">教育培训<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<ul>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/train/special-list?spFlag=0"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="持证上岗" href="javascript:void(0)">持证上岗</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/tables/tab-anlist"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="安全生产教育台账" href="javascript:void(0)">教育台账</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</ul>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<div class="div_omenu">&ndash;%&gt;--%>
<%--            &lt;%&ndash;<div class="div_otop">设备设施管理<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<ul>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/product/mequipment-list"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="主要设备清单" href="javascript:void(0)">主要设备清单</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/sequipment/sequipment-list"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="特种设备检测" href="javascript:void(0)">特种设备检测</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/product/lightning-list"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="防雷防静电" href="javascript:void(0)">防雷防静电</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/safety-facilities"&ndash;%&gt;--%>
<%--            &lt;%&ndash;data-title="安全设施登记台账" href="javascript:void(0)">安全设施登记台账</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</ul>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</div>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<ul class="oul">&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/evaluate/evaluation-list?flag=0" data-title="评价评估档案"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">评价评估档案</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/evaluate/zheng-list" data-title="各类许可证档案"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">各类许可证档案</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/information/information3" data-title="两重点一重大"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">两重点一重大</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/tables/tab-weilist" data-title="危险作业证"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">危险作业证</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/tables/tab-jianglist" data-title="安全奖惩"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">安全奖惩</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;<li><a data-href="${ly }/company/tables/tab-shilist" data-title="事故报告和处理"&ndash;%&gt;--%>
<%--            &lt;%&ndash;href="javascript:void(0)">事故报告和处理</a></li>&ndash;%&gt;--%>
<%--            &lt;%&ndash;</ul>&ndash;%&gt;--%>
<%--        </c:if>--%>
<%--        <!--职业健康管理 管理档案-->--%>
<%--        <c:if test="${leftBasic == 10}">--%>
...
<%--        localStorage.setItem('areaType', 2);--%>
<%--        &lt;%&ndash;function threeActive(v){&ndash;%&gt;--%>
<%--        &lt;%&ndash;var str = document.querySelectorAll('.children_div')&ndash;%&gt;--%>
<%--        &lt;%&ndash;v.classList.add('active')&ndash;%&gt;--%>
<%--        &lt;%&ndash;var arr = v.parentNode.parentNode&ndash;%&gt;--%>
<%--        &lt;%&ndash;arr.style.display = "none"&ndash;%&gt;--%>
<%--        &lt;%&ndash;if(v.innerText=='教育培训'){&ndash;%&gt;--%>
<%--        &lt;%&ndash;str[0].style.display = 'block'&ndash;%&gt;--%>
<%--        &lt;%&ndash;str[1].style.display = 'none'&ndash;%&gt;--%>
<%--        &lt;%&ndash;}else if(v.innerText=='设备设施管理'){&ndash;%&gt;--%>
<%--        &lt;%&ndash;str[0].style.display = 'none'&ndash;%&gt;--%>
<%--        &lt;%&ndash;str[1].style.display = 'block'&ndash;%&gt;--%>
<%--        &lt;%&ndash;}&ndash;%&gt;--%>
