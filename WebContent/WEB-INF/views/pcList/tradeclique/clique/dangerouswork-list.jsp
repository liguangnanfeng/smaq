...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/tradeclique/dangerouswork-list" method="post">
        <div class="dis-ib">
        <span>企业名称：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <button class="btn btn-primary radius" onclick="showadd('')"><i class="Hui-iconfont">&#xe600;</i> 添加高危作业</button>
...
function showadd(id){
	show_dialog("添加高危作业", '${ly }/tradeclique/dangerouswork-add');
}
</script> 
</body>
</html>