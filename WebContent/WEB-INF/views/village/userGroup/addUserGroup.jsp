  ...
  <div class="page-container">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        	...
        	<a href="javascript:void(0);" class="btn btn-primary radius" id="toSearch" style="background-color: #ddd;border-color: #ddd;" >查询</a>
      </div>
      ...
      <div class="formControls col-xs-8 col-sm-9" style="text-align:center;">
      		...
      		<a href="<c:url value='/village/groupIndex' /> " class="btn btn-primary radius" style="background-color: #ddd;border-color:#ddd;width:80px;margin-left:20px;">取消</a>
      </div>
