...
<nav class="breadcrumb">
    <i class="Hui-iconfont">&#xe67f;</i> 首页 <span class="c-gray en">&gt;</span> 企业信息数据 <span class="c-gray en">&gt;</span>
    组织架构
...
<%--                //只渲染第一条--%>
        ...
        <table class="table table-border table-bordered">
            ...
            <tr class="text-c">
                <td>
                    <button class="btn-depart" onclick="showadd(2)"><i class="Hui-iconfont">&#xe600;</i> 添加车间</button>
                </td>
            </tr>
            </thead>
            <tbody id="table1">
...
<script type="text/javascript">
    ...
    function editCompany() {
        ...
        var dom = $('#tbl tr:first-child') ;
        $("#name").val(dom.attr("data-name"));
        $("#id").val(dom.attr("data-id"));
        if (userType == '3') {
