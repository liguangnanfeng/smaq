...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>其他</span> 
  ...
  <div class="page-container">
    <div class="text-c">
    <form action="${ly }/company/tables/tab-health/7" method="post">
      <div class="dis-ib">
        <span>资料名称：</span>
           ...
           <td>${index.index+1 }</td>
            ...
            <td>
              <div class="btn-upload">
                <div class="btn btn-primary-outline radius" onclick="openzl(${h.id})"  style="height: 21px;line-height: 21px;padding: 0 2px;margin-top: 4px;">更改资料</div>
              </div>
...
function upload() {
  $.ajaxFileUpload({
      url: getRootPath() + '/company/tables/h-leadin?isType=48&id='+id, //用于文件上传的服务器端请求地址
