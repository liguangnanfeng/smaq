...
<body>
    ...
    <div class="page-container">
        <div class="HuiTab">
            <div class="tabBar clearfix">
                <a href="${ly }/town/cx/tables/tab-yjlist?c=${c}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" class="tab" style="border-radius:5px 0 0 5px;">应急预案</a>
                <a class="tab current" href="${ly }/town/cx/tables/tab-yllist?c=${c}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" style="border-radius:0 5px 5px 0;">应急预案演练</a>
            </div>
    ...
    function form_submit() {
        ...
        $.post(getRootPath() + "/company/tables/tab-yladd", {
            name: $("#modal_name").val(),
    ...
    /*删除*/
    function del(id) {
        $.post(getRootPath() + "/company/tables/tab-yldel", {
            id: id,
        }, function(reuslt) {
            location.reload()
        })
