...
<body>
  <%@ include file="../trade/top.jsp"%>
  <%@ include file="clique-left3.jsp"%>
  <!-- 中间主页 -->
  ...
  <section class="Hui-article-box">
    <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
      <div class="Hui-tabNav-wp">
        <ul id="min_title_list" class="acrossTab cl">
          <li class="active">
            <span title="首页" data-href="${ly }/village/welcome">首页</span>
            <em></em>
          </li>
        </ul>
      </div>
    ...
    <div id="iframe_box" class="Hui-article">
      <div class="show_iframe">
        ...
        <iframe scrolling="yes" frameborder="0" src="${ly }/steel/welcome"></iframe>
      </div>
    </div>
  </section>
