...
<div class="page-container">
    <div class="HuiTab">
      <div class="tabBar clearfix">
        <a href="${ly }/town/cx/tables/tab-yjlist?c=${c}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" class="tab current" style="border-radius:5px 0 0 5px;">应急预案</a>
        <a class="tab" href="${ly }/town/cx/tables/tab-yllist?c=${c}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" style="border-radius:0 5px 5px 0;">应急预案演练</a>
      ...
      <c:if test="${c != 1}">
          <div class="text-c mt-20">
            <form action="${ly }/town/cx/tables/tab-yjlist?c=${c}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" method="post">
