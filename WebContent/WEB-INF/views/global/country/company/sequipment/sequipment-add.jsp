...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="type" name=""  style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" value="" onfocus="WdatePicker({dateFmt:'yyyy-MM',maxDate:'#F{$dp.$D(\'safeTime3\')}'})" id="safeTime2" name="safeTime2" class="input-text Wdate mb-5 mt-5" style="width:350px;">
      </div>
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">到期时间：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text"  value="" onfocus="WdatePicker({dateFmt:'yyyy-MM',minDate:'#F{$dp.$D(\'safeTime3\')}'})" id="safeTime3" name="safeTime3" class="input-text Wdate mb-5 mt-5" style="width:350px;">
      </div>
    </div>
    <div class="row cl">
