    ...
    <div class="panel-body">
      ...
      <div class="mt-15 pos-r">
        <div class="div_tx div_yj" style="padding-top:15px;">
          ...
          <a class="one_tx radius pos-r" data-title="持证上岗" data-href="${ly }/global/warning/sperson-list?isTime=3&home=1" onclick="Hui_admin_tab(this)" href="javascript:;" style="margin-left:1%;background:#46D1E5;">
              ...
              <a class="one_tx radius pos-r" data-title="特种设备检测" data-href="${ly }/global/warning/sequipment-list?isTime=3&home=1" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#60D1FF;">
              ...
              <a class="one_tx radius pos-r" data-title="职卫检测、体检" data-title="职卫检测、体检" data-href="${ly }/global/warning/detection-list?isTime=3" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#34B5ED;margin-right:0;">
