    ...
    <div class="panel-body">
      <div class="div_tx">
        ...
        <div class="div_company">
          ...
          <span  style="margin-top:10px"><a data-href="${ly }/village/company/company-list" data-title="全部企业" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">企业数量：${number }</a></span>
          <span style="margin-top:10px">
            <a data-href="${ly }/town/company/company-map" data-title="企业分布图" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">企业分布图<img alt="" src="${ly }/images/fore/fb.jpg"/></a>
          </span>
        </div>
        <div class="div_company2">
          <span style="margin-top:10px">
            <a data-href="${ly }/village/monitor-list-supervise" data-title="重点部位/装置实时监控" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">重点部位/装置实时监控<img alt="" src="${ly }/images/fore/sous.jpg"/></a>
          </span>
          <span style="margin-top:10px">
            <a data-href="${ly }/village/company/company-list?doubleDanger=1" data-title="高危行业" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">高危行业<img alt="" src="${ly }/images/fore/sous.jpg"/></a>
          </span>
      ...
      <div class="mt-15 pos-r">
        <div class="div_tx div_yj" style="padding-top:15px;">
          <div class="title_xw pos-r" style="border-bottom:1px solid #F6F6F6;color:#FB0005;"><div class="bt_yuj">预警栏(${count[0] + count[1] + count[2] + count[3] + count[4] + count[5] + count[9] + zdsgyh + count[8]})</div></div>
        ...
        <div class="div_tx div_yh pos-a" style="height:313px;padding: 13px 20px 0px;">
          <div class="title_xw pos-r" style="border-bottom:1px solid #F6F6F6;color:#FB0005;"><div class="bt_yuj" style="width:180px">在线监测预警.报警</div></div>
           ...
           <%-- <a class="one_tx radius pos-r" id="toOpenDanger"  href="javascript:;"  style="width:100%;margin-right:0;background:#1450DD;">
            ...
            <a class="one_tx radius pos-r"  data-title="重大危险源隐患企业列表" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/toZdCompanyList?hazard=1" style="width:100%;margin-right:0;background:#1450DD;<c:if test="${session_user.id != 290}">width:100%</c:if>" >
            ...
            <a class="one_tx radius pos-r"  data-title="有限（受限）空间作业" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/toGwCompanyList?danger=1" style="width:100%;margin-right:0;background:#1450DD;<c:if test="${session_user.id != 290}">width:100%</c:if>" >
        ...
        <div class="modal-dialog" style="width:800px">
            <div class="modal-content radius">
                ...
                <div class="modal-body">
                  <a class="one_tx radius pos-r" data-dismiss="modal" aria-hidden="true" data-title="各类评价评估" data-href="${ly }/village/evaluate/evaluation-list?isTime=6" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#FFA160;">
                    <img alt="" src="${ly }/images/httb4.png"/>
                    <font class="font_tx1 pos-a <c:if test="${count[4] >0}">blink</c:if>">${count[4] }</font>
                    <font class="font_tx2 pos-a">评价评估</font>
                  </a>
                  <a class="one_tx radius pos-r" data-dismiss="modal" aria-hidden="true" data-title="各类许可证" data-href="${ly }/village/evaluate/zheng-list?isTime=6" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#FF9346;">
      ...
      <div class="div_tx mt-15">
        ...
        <div class="div_hz">
          ...
          <div class="div_hui">
            ...
            <a class="one_huiz" style="width:40%;border:0px;" data-title="企业自查-隐患排查记录" data-href="${ly }/village/danger-index-list?flag=1" onclick="Hui_admin_tab(this)" href="javascript:;" style="border:0px;">
        ...
        <div class="div_hz">
          ...
          <div class="div_hui">
            ...
            <a class="one_huiz" style="width:40%;border:0px;" data-title="部门抽查-隐患排查记录" data-href="${ly }/village/danger-index-list?flag=3" onclick="Hui_admin_tab(this)" href="javascript:;" style="border:0px;">
        ...
        <div class="div_hz" style="margin-right:0px;">
          ...
          <div class="div_hui">
            ...
            <a class="one_huiz" style="width:40%;border:0px;" data-title="行政检查-隐患排查记录" data-href="${ly }/village/danger-index-list?flag=4" onclick="Hui_admin_tab(this)" href="javascript:;" style="border:0px;">
