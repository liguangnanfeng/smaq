...
<div class="page-container">
  <%--  <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;">
   ...
   <%-- <div class="cl pd-5 bg-1 bk-gray mt-20">
        &lt;%&ndash;<p class="paging">&ndash;%&gt;
        &lt;%&ndash;<a href="${ly }/village/recheck-list?flag=${flag}&page=${page-1 }">    &lt; 上一页 </a>&ndash;%&gt;
        &lt;%&ndash;<strong>第${page+1}页/共${count}页</strong>&ndash;%&gt;
        &lt;%&ndash;<a href="${ly }/village/recheck-list?flag=${flag}&page=${page+1}">下一页 &gt;</a>&ndash;%&gt;
        &lt;%&ndash;</p>&ndash;%&gt;
    </div>--%>
    <div class="mt-20">
