...
<body>
    <div class="page-container" style="width:150mm;margin:auto;padding:10px 0 0 0;">
        ...
        <div class="row cl mb-20">
          <div class="tabBar clearfix">
            ...
            <c:if test="${empty check}">
            <a href="javascript:void(0)" onclick="layer.alert('请先保存现场检查记录')">隐患整改意见书</a>
            ...
            <c:if test="${!empty check}">
                ...
                <c:choose>
                    ...
                    <a href="javascript:void(0)" onclick="layer.alert('本次检查没有隐患，无需整改')">隐患整改意见书</a>
        ...
        <p class="dant1  mt-20" style="text-align:center;border-bottom:1px solid #000;margin-bottom:3px;" align="center">
            <b><span style="font-family:华文中宋;font-weight:bold;font-size:18pt;"><span>现场检查记录</span></span></b>
        </p>
        <p class="dant1" style="text-align:center;border-top:1px solid #000;margin-bottom:15px;" align="center">
        </p>
        ...
        <p class="MsoNormal" style="text-align:left;">
            ...
            <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom; width:14%;display:inline-block;text-align:center;" contenteditable="true">&nbsp;<fmt:formatDate value="${empty check ? timenow : check.realTime}" pattern="yyyy"/></span></u>
        ...
        <p class="MsoNormal" style="text-indent:23.0000pt;text-align:left;">
            <span style="vertical-align: bottom;"><span>我们受</span></span>
            ...
            <span style="vertical-align: bottom;"><span>委托，对你单位进行安全检查。</span></span>
        </p>
    ...
    <p class="MsoNormal" style="text-align:left;margin-top:15px">
        ...
        <u><span style="border-bottom:1px solid #333;vertical-align: text-bottom;width:20%;display:inline-block;" contenteditable="true">&nbsp;${check.dapartContact }</span></u>
    </p>
    <p class="MsoNormal" style="text-align:right;margin-top:15px">
        <span style=""><span contenteditable="true">&nbsp;<fmt:formatDate value="${empty check ? timenow : check.realTime }" pattern="yyyy"/>&nbsp;</span>年<span contenteditable="true">&nbsp;&nbsp;<fmt:formatDate value="${empty check ? timenow : check.realTime }" pattern="MM"/>&nbsp;</span>月<span contenteditable="true">&nbsp;&nbsp;<fmt:formatDate value="${empty check ? timenow : check.realTime }" pattern="dd"/>&nbsp;</span>日</span><span style=""></span>
    </p>
