      ...
      <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tbody>
          ...
          <tr class="text-c">
            ...
            <td>
              <a style="text-decoration:none" onClick='show_tab("编辑公告信息", "/village/notice/notice-add?id=${no.id}");'  href="javascript:;" title="编辑">查看/编辑</a>
              <a style="text-decoration:none"  href="javascript:;" title="删除" onclick="del_(${no.id})">删除</a>
            </td>
          </tr>
          </c:forEach>
          <!-- 循环结束 -->
...
function del_(id) {
  layer.confirm("确定删除么？",function(i) {
    $.post(getRootPath() + "/village/notice/notice-del",{
      id : id
    },function(result) {
      location.reload();
    })
