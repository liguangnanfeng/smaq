...
/* 弹窗工具添加 */
function addgj() {
  window.location.href = "/company/study/selectyes?type="+${type};
}
...
<body>
	    ...
	    <span class="c-gray en">&gt;</span> <span>流程确认</span>
    ...
    <div class="mt-20">
    	<table >
          ...
          <tr>
          	<td class="text-c" style="width:60px;height: 90px;">
                
            </td>

            <td class="text-c" style="width:60px;height: 90px;">
                <button class="btn btn-primary radius" onClick="addgj()">有该流程</button>
            </td>
            <td class="text-c" style="width:60px;height: 90px;">

            <a class="btn btn-primary radius" style="line-height: 1.6em;" href="javascript:history.back(-1)" title="无该流程">无该流程</a>
                <%--<button class="" onClick="parent.close_tab(function(){})">无该流程</button>--%>
            </td>
            <td class="text-c" style="width:60px;height: 90px;">
