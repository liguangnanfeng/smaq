...
var rootPath = getRootPath();
  ...
  var info = {
      ...
      getCompanyList : function(page,limit,companyName){
        $.ajax({
          url : rootPath + "/village/company/getZdCompanyList",
          type : 'post',
          data : {
            page : page,
            limit : limit,
          ...
          success : function(data){
            if(undefined != data.list && data.list.length > 0){
              ...
              $("#showTotal").html(0);
              $("#showListBody").html('<tr class="text-c"><td colspan="4">暂无重大危险源企业</td></tr>');
            }
