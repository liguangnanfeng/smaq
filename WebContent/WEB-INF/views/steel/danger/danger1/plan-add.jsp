  ...
  <form class="form form-horizontal" id="form">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="title" value="${model.title }" style="width:350px" class="input-text" maxlength="50"/>
      </div> 
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">部门：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="depart" value="${model.part }" style="width:350px" class="input-text" maxlength="100"/>
      </div> 
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        ...
        <a class="btn btn-primary radius ml-20" data-title="查看检查表_${model.id }" data-href="${ly }/company/model-show/${model.id}" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont" style="font-size:15px;">&#xe695;</i> 查看检查表</a>
      </div> 
    </div>
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="cheker" style="width:350px" class="input-text" maxlength="50"/>
      </div> 
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">受检负责人：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="dapartContact" style="width:350px" class="input-text" maxlength="50"/>
      </div> 
    </div>
    <div class="row cl">
...
var type = ${model.type};
var industryId = ${model.industryId};
...
function article_save_submit() {
  ...
  var i = layer.load();
  $.post(getRootPath() + "/company/plan-save", {
    title : $("#title").val(),
    depart : $("#depart").val(),
    modelId : modelId,
    type : type,
    ...
    if(result.status == '1') {
      layer.alert(result.map.message);
        ...
        show_dialog('实施检查_' + id_, '/village/plan-next?id=' + id_);
    }
  })
}
</script>
