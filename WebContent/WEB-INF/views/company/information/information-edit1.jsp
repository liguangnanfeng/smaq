  ...
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="name" value="${c.name }" style="width:350px" class="input-text required" maxlength="50" disabled="disabled">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <div class="one_yxuan">
          <input class="check_gao" onclick="javascript:show_dialog('两重点一重大','/company/information/information-edit3')" type="radio" name="hazard" value="1" <c:if test="${c.hazard == 1}">checked</c:if>/>
          <font>是</font>
        </div>
        <div class="one_yxuan">
...
<script type="text/javascript" src="${ly }/js/regRegion.js?v=0.2"></script>
</html>