...
<script type="text/javascript">
  function load_axfxgkxt() {
    $.post("/company/safety-system/check",{
...
<%--  TODO企业信息左侧导航--%>
  <aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
      <dl>
        <dt>
          <i class="Hui-iconfont">&#xe643;</i>企业信息
          <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
        </dt>
        <dd>
          <ul>
            <li><a data-href="${ly }/company/basic-information" data-title="基本信息" href="javascript:void(0)">基本信息</a></li>
          </ul>
          ...
          <ul>
            <li><a data-href="${ly }/company/product/material-list" data-title="主要原辅材料" href="javascript:void(0)">主要原辅材料</a></li>
            <li><a data-href="${ly }/company/product/product-list" data-title="主要生产产品" href="javascript:void(0)">主要生产产品</a></li>
            <li><a data-href="${ly }/company/process/process-list" data-title="生产工艺流程图" href="javascript:void(0)">生产工艺流程图</a></li>
      ...
      <dl id="axfxgkxt">
        ...
        <dd>
          ...
          <div class="div_omenu">
            ...
            <ul>
            	<li><a data-href="${ly }/company/safety-system/assess5" data-title="评估操作" href="javascript:void(0)">评估操作</a></li>
        <%--     <li><a data-href="${ly }/company/safety-system/assess5" data-title="重大和较大风险评估" href="javascript:void(0)">重大和较大风险评估</a></li> wz 2018.10.17--%>
        <%--     <li><a data-href="${ly }/company/safety-system/assess-list" data-title="一般和较小风险评估" href="javascript:void(0)">一般和较小风险评估</a></li> wz 2018.10.17--%>
              <li><a data-href="${ly }/company/safety-system/control-list2?flag=1" data-title="评估结果" href="javascript:void(0)">评估结果</a></li>
              <li><a data-href="${ly }/company/safety-system/control-list2?flag=3" data-title="风险分布表" href="javascript:void(0)">风险分布表</a></li>
              <li><a data-href="${ly }/company/safety-system/control-list2?flag=2" data-title="风险分布图" href="javascript:void(0)">风险分布图</a></li>
              <%-- <li id="gm3_"><a data-href="${ly }/company/safety-system/assess4" data-title="安全风险空间分布图" href="javascript:void(0)">安全风险空间分布图</a></li> --%>
              <%-- <!-- 判断危化品企业显示 -->
          ...
          <div class="div_omenu">
            ...
            <ul>
              <%-- <li><a data-href="${ly }/company/safety-system/assess-bei" data-title="手册工具" href="javascript:void(0)">手册工具</a></li> --%>
              <li><a data-href="${ly }/company/safety-system/risk-information-list?flag=1" data-title="公司风险公告牌" href="javascript:void(0)">公司风险公告牌</a></li>
              <li><a data-href="${ly }/company/safety-system/risk-information-list?flag=2" data-title="车间风险公告牌" href="javascript:void(0)">车间风险公告牌</a></li>
              <li><a data-href="${ly }/company/safety-system/risk-information-list?flag=3" data-title="岗位风险公告牌" href="javascript:void(0)">岗位风险公告牌</a></li>
              <li><a data-href="${ly }/company/safety-system/ying-add" data-title="岗位应急处置卡" href="javascript:void(0)">岗位应急处置卡</a></li>
              <li><a data-href="${ly }/company/safety-system/harm-list" data-title="告知牌" href="javascript:void(0)">告知牌</a></li>
            </ul>
          </div>
          <%-- <div class="div_omenu">
...
<%-- TODO 通过data-href  可以在域中通过getAttrbute 来进行获取内容--%>
      ...
      <dl class="list_an" id="ypycn_qyd">
        ...
        <dd>
        	<div class="div_omenu">
            	...
            	<ul class="oul">
              		<li><a data-href="${ly }/company/study/management-guide" data-title="管理手册" href="javascript:void(0)">管理手册</a></li>
            	</ul>
            </div>
            	<div class="div_omenu">
              		<div  class="div_otop">流程管理<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
              		<ul>
                		<li><a data-href="${ly }/company/study/select?type=1" style="padding-left:55px;" data-title="特殊作业流程" href="javascript:void(0)">特殊作业流程</a></li>
                		<li><a data-href="${ly }/company/study/select?type=2" style="padding-left:55px;" data-title="检维修作业流程" href="javascript:void(0)">检维修作业流程</a></li>            
                		<li><a data-href="${ly }/company/study/select?type=3" style="padding-left:55px;"data-title="承包商作业流程" href="javascript:void(0)">承包商作业流程</a></li>
            <%--    	
        	...
        	<div class="div_omenu">
            	...
            	<ul>
             	 	<li><a data-href="${ly }/company/study/naturaldanger-list" data-title="固有风险研判" href="javascript:void(0)">固有风险研判</a></li>
              		<li><a data-href="${ly }/company/study/temporaryrisk-list" data-title="临时风险研判" href="javascript:void(0)">临时风险研判</a></li>
              		<li><a data-href="${ly }/company/study/greatdanger-list" data-title="重大/较大隐患治理风险研判" href="javascript:void(0)">重大/较大隐患治理风险研判</a></li>
            	</ul>
          	</div>
          	<ul>
              	<li><a data-href="${ly }/company/study/targetassessment" data-title="目标履职考核" href="javascript:void(0)">目标履职考核</a></li>
            </ul>
        	<ul>
            	<li><a data-href="${ly }/company/study/promise" data-title="承诺公告" href="javascript:void(0)">承诺公告公示</a></li>
          	</ul>
          	<ul>
          		<li><a data-href="${ly }/company/study/files-select" data-title="档案管理" href="javascript:void(0)">档案管理</a></li>
          	</ul>
        </dd>
      </dl>
      ...
      <dl class="list_an" id="source_company">
        ...
        <dd>
        	<div class="div_omenu">
            	...
            	<ul>
            		<li><a data-href="${ly }/company/study/department-list?sign=2" data-title="机制文件" href="javascript:void(0)">管控架构</a></li>
              		<li><a data-href="${ly }/company/source/management-guide" data-title="管控机制" href="javascript:void(0)">机制文件</a></li>	
            	</ul>
           </div>
        	 <div class="div_omenu2">
            	<div  class="div_otop2">管控措施<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
            	<ul class="oul">
            		<li><a data-href="${ly }/company/source/equipment?type=1" data-title="设备设施管理" href="javascript:void(0)">设备设施管理</a></li>
              		<li><a data-href="${ly }/company/source/staff" data-title="人员管理" href="javascript:void(0)">人员管理</a></li>
              	</ul>
              	<div class="div_omenu">
              		<div  class="div_otop">在线监测<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
              			<ul>
                			<li><a data-href="${ly }/company/source/source-video?flag=2" data-title="实时监控" href="javascript:void(0)">实时监控</a></li>
                			<li><a data-href="${ly }/village/company/zdlist?hazard=1&yzz=1" data-title="报警设备" href="javascript:void(0)">报警设备</a></li>
         				</ul>
            	</div>	
              	<ul class="oul">
              		<li><a data-href="${ly }/company/source/distribution" data-title="风险分布图" href="javascript:void(0)">风险分布图</a></li>
              		<li><a data-href="${ly }/company/source/publicity?flag=1" data-title="公示" href="javascript:void(0)">公示</a></li>		
            	</ul>
        	 </div>
            <ul>
            		<li><a data-href="${ly }/company/source/model-list-cx" data-title="隐患排查治理" href="javascript:void(0)">隐患排查治理</a></li>
            </ul>
      		<div class="div_omenu">
            	<div  class="div_otop">特殊作业<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
            	<ul class="oul">
              		<li><a data-href="${ly }/company/source/specialWork?type=1" data-title="非化工液氨使用企业" href="javascript:void(0)">非化工液氨使用企业</a></li>
              		<li><a data-href="${ly }/company/source/specialWork?type=2" data-title="粉尘涉爆企业" href="javascript:void(0)">粉尘涉爆企业</a></li>
              		<li><a data-href="${ly }/company/source/specialWork?type=3" data-title="高温熔融金属现场运输" href="javascript:void(0)">高温熔融金属现场运输</a></li>
              		<li><a data-href="${ly }/company/source/specialWork?type=4" data-title="工贸行业有限空间安全作业" href="javascript:void(0)">工贸行业有限空间安全作业</a></li>
              		<li><a data-href="${ly }/company/source/specialWork?type=5" data-title="冶金企业煤气" href="javascript:void(0)">冶金企业煤气</a></li>
            	</ul>
        	 </div>
        	 <div class="div_omenu">
            	...
            	<ul class="oul">
            		...
            		<li><a data-href="${ly }/company/facilities/facilities-list?flag=1" data-title="消防设备设施" href="javascript:void(0)">消防设备设施</a></li>
            		<li><a data-href="${ly }/company/facilities/facilities-list?flag=2" data-title="应急设备设施" href="javascript:void(0)">应急设备设施</a></li>
            	</ul>
        	 </div>
        	<ul>
            	<li><a data-href="${ly }/company/source/files-select" data-title="档案管理" href="javascript:void(0)">档案管理</a></li>
          	</ul>
        </dd>
      </dl>
      ...
      <dl class="list_an">
        ...
        <dd>
          <ul>
            <li><a data-href="${ly }/company/tables/tab-list?isType=1" data-title="安全生产管理制度" href="javascript:void(0)">管理制度</a></li>
          </ul>
          <div class="div_omenu">
            <div  class="div_otop">责任制<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
            <ul>
              <li><a data-href="${ly }/company/tables/tab-list?isType=0" data-title="安全生产责任制" href="javascript:void(0)">责任制</a></li>
              <li><a data-href="${ly }/company/information/information6" data-title="安全生产管理网络图" href="javascript:void(0)">管理网络图</a></li>
            </ul>
          </div>
          <div class="div_omenu2">
            ...
            <div class="div_omenu">
              ...
              <ul>
                <li><a data-href="${ly }/company/train/special-list?spFlag=0" style="padding-left:55px;" data-title="持证上岗" href="javascript:void(0)">持证上岗</a></li>
                <li><a data-href="${ly }/company/tables/tab-anlist" style="padding-left:55px;" data-title="安全生产教育台账" href="javascript:void(0)">教育台账</a></li>
                <%-- <li><a data-href="${ly }/company/tables/tab-list?isType=2" data-title="培训需求调查表" href="javascript:void(0)">培训需求调查表</a></li>
                ...
                <li><a data-href="${ly }/company/tables/tab-list?isType=7" data-title="培训记录表" href="javascript:void(0)">培训记录表</a></li> --%>
              </ul>
            </div>
            <div class="div_omenu">
              <div  class="div_otop">设备设施管理<i class="Hui-iconfont top-iconfont">&#xe6d5;</i></div>
              <ul>
                <li><a data-href="${ly }/company/product/mequipment-list" style="padding-left:55px;" data-title="主要设备清单" href="javascript:void(0)">主要设备清单</a></li>
                <li><a data-href="${ly }/company/sequipment/sequipment-list" style="padding-left:55px;" data-title="特种设备检测" href="javascript:void(0)">特种设备检测</a></li>
                <li><a data-href="${ly }/company/product/lightning-list" style="padding-left:55px;" data-title="防雷防静电" href="javascript:void(0)">防雷防静电</a></li>
                <li><a data-href="${ly }/company/safety-facilities" style="padding-left:55px;" data-title="安全设施登记台账" href="javascript:void(0)">安全设施登记台账</a></li>
                <%-- <li><a data-href="${ly }/company/tables/tab-list?isType=9" style="padding-left:55px;" data-title="年度综合检维修计划" href="javascript:void(0)">年度综合检维修计划</a></li>
                ...
                <li><a data-href="${ly }/company/tables/tab-list?isType=11" style="padding-left:55px;" data-title="移动电气设备绝缘电阻测试表" href="javascript:void(0)">移动设备绝缘测试表</a></li> --%>
              </ul>
            </div>
            <ul class="oul">
              ...
              <li><a data-href="${ly }/company/information/information3" data-title="两重点一重大" href="javascript:void(0)">两重点一重大</a></li>
              <%-- <li><a data-href="${ly }/company/tables/tab-yjlist" data-title="应急预案" href="javascript:void(0)">应急预案</a></li> --%>
              <li><a data-href="${ly }/company/tables/tab-weilist" data-title="危险作业证" href="javascript:void(0)">危险作业证</a></li>
              <li><a data-href="${ly }/company/tables/tab-jianglist" data-title="安全奖惩" href="javascript:void(0)">安全奖惩</a></li>
              <li><a data-href="${ly }/company/tables/tab-shilist" data-title="事故报告和处理" href="javascript:void(0)">事故报告和处理</a></li>
            </ul>
          </div>
      ...
      <dl>
        <dt>
          <i class="Hui-iconfont">&#xe687;</i>职业健康管理
          <i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
        </dt>
        <dd>
          <ul>
            <li><a data-href="${ly }/company/labor/labor-list" data-title="劳动防护用品配备" href="javascript:void(0)">劳动防护用品配备</a></li>
          ...
          <div class="div_omenu">
            ...
            <ul>
              <li><a data-href="${ly }/company/evaluate/detection-list" data-title="职卫检测、体检" href="javascript:void(0)">职卫检测、体检</a></li>
              <%-- <li><a data-href="${ly }/company/evaluate/health-list" data-title="职业健康体检" href="javascript:void(0)" style="color:#fff;">职业健康体检</a></li> --%>
              <li><a data-href="${ly }/company/tables/tab-health/2" data-title="职业卫生管理" href="javascript:void(0)">职业卫生管理</a></li>
              <li><a data-href="${ly }/company/tables/tab-health/3" data-title="职业卫生宣传培训" href="javascript:void(0)">职业卫生宣传培训</a></li>
              <li><a data-href="${ly }/company/tables/tab-health/4" data-title="职业病危害因素监测与检测评价" href="javascript:void(0)">职业病危害因素检测评价</a></li>
              <li><a data-href="${ly }/company/tables/tab-health/5" data-title="用人单位职业健康监护管理" href="javascript:void(0)">职业健康监护管理</a></li>
              <li><a data-href="${ly }/company/cyryjkjh" data-title="劳动者个人职业健康监护" href="javascript:void(0)">劳动者个人职业健康监护</a></li>
              <li><a data-href="${ly }/company/tables/tab-health/7" data-title="其他" href="javascript:void(0)">其他</a></li>
            </ul>
          </div>
        </dd>
      </dl>
      ...
      <dl>
        ...
        <dd>
          ...
          <ul>
            <!--<li><a data-href="${ly }/village/monitor-list" data-title="实时监控设置" href="javascript:void(0)">实时监控设置</a></li> 2018.12.15 zhangcl-->
            <li><a data-href="${ly }/village/to_monitor-list?flag=1" data-title="实时监控设置" href="javascript:void(0)">实时监控设置</a></li>
