...
<body>
  ...
  <div class="tabBar clearfix">
    ...
    <a style="border-radius:0 5px 5px 0;" href="${ly}/village/warning/examination-list?isTime=${isTime}">职业健康体检</a>
  </div>
    <div class="page-container">
      <div class="text-c">
        <form action="${ly}/village/warning/detection-list" method="post">
          <div class="dis-ib">
            <span>所属企业：</span>
