...
<div class="page-container">
    ...
    <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;">
        <a class="btn default ${flag == 1 ? 'btn-primary' : 'radius'}" href="${ly }/global/check-list?flag=1&status=2">企业自查</a>
        <a class="btn default ${flag == 2 ? 'btn-primary' : 'radius'}" href="${ly }/global/check-list?flag=2&status=2">行政检查</a>
        <a class="btn default ${flag == 3 ? 'btn-primary' : 'radius'}" href="${ly }/global/check-list?flag=3&status=2">第三方检查</a>
        <%-- <a class="btn default ${flag == 2 ? 'btn-primary' : 'radius'}" href="${ly }/village/check-list?flag=2">执法检查</a> --%>
    </div>

    <div class="text-c">
        <form action="${ly }/global/check-list2?flag=${flag}" method="post">
            <div class="dis-ib">
                <span>检查表名称：</span>
