        ...
        <tbody>
          ...
          <c:forEach items="${list }" var="be" varStatus="index">
            ...
            <td>
              ...
              <a style="text-decoration:none" onClick="show_dialog('现场检查记录_${be.checkId }', '${ly}/village/check-document?checkId=${be.checkId }&flag=8')" href="javascript:;">现场检查记录</a><br>
              <a style="text-decoration:none" onClick="show_dialog('整改意见书_${be.checkId }', '${ly}/village/check-document?checkId=${be.checkId }&flag=1')" href="javascript:;">整改意见书</a><br>
              <a style="text-decoration:none" onClick="show_dialog('整改复查意见书_${be.checkId }', '${ly}/village/check-document?checkId=${be.checkId }&flag=2')" href="javascript:;">整改复查意见书</a><br>
              <%-- <c:if test="${be.c > 0}">
