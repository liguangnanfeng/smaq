...
function imageLabel(e) {
    function a() {
        function e() {
            ...
            e.each(function (e, i) {
                ...
                var n = $(i), t = n.width() * n.height(), l = 0;
                $.each(a, function (e, a) {
                    t <= a && l++
                }), n.css({"z-index": l})
            })
        ...
        function a() {
            var e = $(".imageLabel-img"), a = $(".imageLabel-jisuan"), i = e[0].naturalWidth, n = e[0].naturalHeight,
                t = e.parents(".imageLabel-img-body").width(), l = e.parents(".imageLabel-img-body").height();
            i / n > t / l ? a.css({width: "100%", height: n / i * t}) : a.css({height: "100%", width: i / n * l})
        }

        var t, s, o, d, c, g, m, r = $(".imageLabel-content"), b = !1, p = !1, v = !1, f = $(".imageLabel-drap-menu");
        $(".imageLabel-content")[0].oncontextmenu = function () {
            ...
            if(a.color=='红色'){
                ...
                s = $('<div class="imageLabel-imgdrop ' + (a.name ? "imageLabel-drop-has1" : "") + '"><span class="imageLabel-imgdrop-font">' + (a.name || "") + '</span><div class="imageLable-i-s"></div></div>');
            }else if(a.color=='橙色'){
                s = $('<div class="imageLabel-imgdrop ' + (a.name ? "imageLabel-drop-has2" : "") + '"><span class="imageLabel-imgdrop-font">' + (a.name || "") + '</span><div class="imageLable-i-s"></div></div>');
            }else if(a.color=='蓝色'){
                s = $('<div class="imageLabel-imgdrop ' + (a.name ? "imageLabel-drop-has3" : "") + '"><span class="imageLabel-imgdrop-font">' + (a.name || "") + '</span><div class="imageLable-i-s"></div></div>');
            }
            ...
            if (d = e.button, 2 != e.button) {
                if (f.hide(), b = !0, r = $(this), t = {
                    ...
                    ex: 0,
                    ey: 0
                }, $(e.target).hasClass("imageLabel-imgdrop")) p = !0, s = $(e.target), c = JSON.parse(s.attr("data-json")), o = $.extend({}, c), n.startArea(); else if ($(e.target).hasClass("imageLable-i")) v = !0, g = $(e.target), s = $(e.target).parents(".imageLabel-imgdrop"), c = JSON.parse(s.attr("data-json")), o = $.extend({}, c); else {
                ...
                f.css({left: e.clientX, top: e.clientY}).show()
            }, 0))
        }), $(".imageLabel-img-boxs").mousemove(function (e) {
            if (b) {
                if (p) o.x = c.x + (e.clientX - t.cx) / t.w, o.ex = c.ex + (e.clientX - t.cx) / t.w, o.y = c.y + (e.clientY - t.cy) / t.h, o.ey = c.ey + (e.clientY - t.cy) / t.h; else if (v) {
                    var a = g.index();
        ...
        y.find(".imageLabel-input-close").click(function () {
            ...
            e.color = y.find("input:radio[name='color']:checked").siblings('b').html()
            if(e.color=='红色'){
                ...
                e.name = u.val(), s.attr("data-json", JSON.stringify(e)), y.removeClass("imageLabel-active"), u.val() ? s.addClass("imageLabel-drop-has1") : s.removeClass("imageLabel-drop-has1")
            }else if(e.color=='橙色'){
                e.name = u.val(), s.attr("data-json", JSON.stringify(e)), y.removeClass("imageLabel-active"), u.val() ? s.addClass("imageLabel-drop-has2") : s.removeClass("imageLabel-drop-has2")
            }else if(e.color=='蓝色'){
                e.name = u.val(), s.attr("data-json", JSON.stringify(e)), y.removeClass("imageLabel-active"), u.val() ? s.addClass("imageLabel-drop-has3") : s.removeClass("imageLabel-drop-has3")
            }
    ...
    var i = {
        ...
        only: !1, shade: !0, editPop: !0, close: function () {
            return !0
        }, edit: function () {
        }, confirm: function () {
            return !0
