    ...
    <div class="panel-body">
      ...
      <div class="mt-15 pos-r">
        ...
        <div class="div_tx div_yh pos-a" style="height:313px;padding: 13px 20px 0px;">
          ...
          <div class="list_zd">
            ...
            <a class="one_tx radius pos-r"  data-title="高危作业隐患企业列表" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/toGwCompanyList?danger=1" style="width:100%;margin-right:0;background:#1450DD;" >
      ...
      <div class="div_tx mt-15">
        ...
        <div class="div_hz" style="margin-right:0px;">
          <span>行政执法</span>
          <div class="div_hui">
            <a class="one_huiz" data-title="行政执法" data-href="${ly }/village/danger-index-list?flag=2" onclick="Hui_admin_tab(this)" href="javascript:;">
              <font>${c2_2 + c2_3}</font>
              <label>全部隐患</label>
            </a>
            <a class="one_huiz" data-title="行政执法" data-href="${ly }/village/danger-index-list?flag=2" onclick="Hui_admin_tab(this)" href="javascript:;">
            ...
            <a class="one_huiz" style="width:40%;border:0px;" data-title="行政执法" data-href="${ly }/village/danger-index-list?flag=2" onclick="Hui_admin_tab(this)" href="javascript:;" style="border:0px;">
