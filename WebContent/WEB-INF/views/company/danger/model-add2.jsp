...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl" style="display: none;">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="part" value="${empty model.part && flag != 1 ? session_user.userName : model.part}"  <c:if test="${flag == 1}">placeholder="根据实际具体填写部门  如一车间"</c:if>  style="width:350px" class="input-text required" maxlength="50"/>
      </div> 
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <button class="btn radius btn-warning size-M" type="button" onClick="show_add_dialog()"><i class="Hui-iconfont">&#xe600;</i>添加检查项目</button>
      </div> 
  ...
  $.post(getRootPath() + "/company/plan-save2", {
    ...
    if(result.status == '1') {
      ...
      layer.confirm("保存成功，是否继续添加检查表？", function(i) {
        ...
        layer.close(i);
        window.location.href = getRootPath()+'/village/plan-next?id=' + id_;
      })
      /* show_dialog('实施检查_' + id_, getRootPath()+'/village/plan-next?id=' + id_); */
    }
  })
}
