...
<head>
    ...
    <script type="text/javascript">
        ...
        function nature(obj) {
            ...
            if (checkType == 0) {
                window.location.href = "${ly}/global/getCheckModelBasic?flag=${flag}&userId=${userId}"
            } else {
                ...
                window.location.href = "${ly}/global/select-all-level1?flag=${flag}&userId=${userId}&checkType=" + checkType
            }
...
<script type="text/javascript">
    ...
    function save_1() {
        ...
        $.ajax({
            type: "POST",
            url: getRootPath() + '/global/save-administrative',
            ...
            success: function (result) {
                if (result.status == 0) {
                    ...
                    layer.alert('保存成功');
                    if (flag == 1) {
                        window.location.href = '${ly }/global/model-list-main?flag=1&userId=${userId}';
                    } else {

                        //行政检查和部门抽查生成完毕后直接跳转到检查页

                        window.location.href = '${ly }/global/plan-next?flag='+flag+'&id='+result.object+"&userId=${userId}";
