...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input  type="text" id="c" name="" style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">物态：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="d" name=""  style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
    ...
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="f" name=""  style="width:350px" class="input-text required"  >
      </div> 
    </div>
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">备注：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <textarea id="g" class="textarea txtarea_sq"></textarea>
      </div> 
    </div>
    <div class="row cl">
  ...
  function save() {
    ...
    $.post(getRootPath() + "/tradeclique/product/material-save",{
      	material:$("#a").val(),
         ...
         show_tab("主要原辅材料",  getRootPath() +'/tradeclique/product/material-list');
    })
  }
  </script>
