    ...
    <div class="panel-body">
      <div class="div_tx">
        ...
        <div class="div_company">
          <p style="margin-top:10px">${session_user.userName }</p>
          ...
          <span style="margin-top:10px">
            <a data-href="${ly }/country/company/company-map" data-title="企业分布图" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com">企业分布图<img alt="" src="${ly }/images/fore/fb.jpg"/></a>
          </span>
        </div>
...
<script type="text/javascript" src="/js/fxgk/industry2-pie.js?v=0.1"></script>
