...
function pr_() {
    $('.caozuo').hide()
    <%--console.log($('.page-container tboby tr td:last-child'))--%>
    <%--$('.page-container tboby tr td:last-child').css('display','none')--%>
...
<div class="page-container">
    <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;">
        <a class="btn default ${empty type ? 'btn-primary' : 'radius'}" href="${ly }/company/safety-system/risk-list">风险点分布表1</a>
  ...
  <div class="page-container" id="div_container" >
    ...
    <div class="mt-20">
        <table class="table table-border table-bordered table-bg table-hover table-sort tab-ndan"  >
            ...
            <th style="width:10%" class="caozuo">操作</th>
            </tr>
            </thead>
            ...
            <c:if test="${empty type}">
                <c:forEach items="${zzjgDep }" var="be">
                        ...
                        <td style="width:10%;" class="text-c">${be.name }</td>
                            ...
                            <td class="text-c caozuo">
                            <c:if test="${empty type}">
                                <button class="btn btn-primary radius caozuo" onClick="addgj('${be.id}')">现场风险辨识</button>
                            </c:if>
                            <c:if test="${empty type}">
                                <button class="btn btn-primary radius caozuo" style="margin-top:10px;" onClick="addgjs('${be.id}')">基础风险辨识</button>
                            </c:if>
										    </td>
                                        </tr>
                                        <c:set value="1" var="x"/>
