$(function () {
  ...
  $(".yhlx").click(function(){
    ...
    $.post(getRootPath() + "/tradeclique/company/lineChartData",{
    	companyId : companyId,
    	sT : $("#sT").val(),
    	eT : $("#eT").val()
    },function(result) {
  ...
  $(".yhdj").click(function(){
    $(".btnyh").removeClass("btnyhxz");
    $(this).addClass("btnyhxz");
    $.post(getRootPath() + "/tradeclique/company/lineChartData2",{
    	companyId : companyId,
    	sT : $("#sT").val(),
    	eT : $("#eT").val()
    },function(result) {
  ...
  $(".yhzg").click(function(){
    $(".btnyh").removeClass("btnyhxz");
    $(this).addClass("btnyhxz");
    $.post(getRootPath() + "/tradeclique/company/zhuChartData",{
    	companyId : companyId,
    	sT : $("#sT").val(),
    	eT : $("#eT").val()
    },function(result) {
  ...
  $(".yhly").click(function(){
    $(".btnyh").removeClass("btnyhxz");
    $(this).addClass("btnyhxz");
    $.post(getRootPath() + "/tradeclique/company/zhuChartData2",{
    	companyId : companyId,
    	sT : $("#sT").val(),
    	eT : $("#eT").val()
    },function(result) {
