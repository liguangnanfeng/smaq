...
<body>
  ...
  <div class="page-container">
    <div id="spTab" class="btn-group" style="text-align: center; margin-bottom: 20px;">
      <a class="btn default radius <c:if test="${empty spFlag || spFlag == 0}"> btn-primary</c:if>" href="${ly }/global/warning/sperson-list?spFlag=0&isTime=${isTime }&home=${home}">全部</a>
      <a class="btn default radius <c:if test="${spFlag == 1}"> btn-primary</c:if>" href="${ly }/global/warning/sperson-list?spFlag=1&isTime=${isTime }&home=${home}">安全管理人员</a>
      <a class="btn default radius <c:if test="${spFlag == 2}"> btn-primary</c:if>" href="${ly }/global/warning/sperson-list?spFlag=2&isTime=${isTime }&home=${home}">危险化学品安全管理人员</a>
      <a class="btn default radius <c:if test="${spFlag == 3}"> btn-primary</c:if>" href="${ly }/global/warning/sperson-list?spFlag=3&isTime=${isTime }&home=${home}">特种作业人员</a>
    </div>    
    
    <!-- 判断其他持证上岗显示 -->
    <div class="list_other">
    <div class="text-c">
      <form action="${ly }/global/warning/sperson-list?spFlag=${spFlag}&home=${home}" method="post">
        <div class="dis-ib">
