...
<body>
  ...
  <div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" data-title="添加特种设备" data-href="${ly }/company/sequipment/sequipment-add" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加特种设备</a>
        ...
        <a class="btn btn-success radius ml-10" href="${ly}/company/download?filename=特种设备模板.xlsx&fileurl=${ly}/upload/newsequipmentmodel.xlsx">特种设备模板下载</a>
      </span>
