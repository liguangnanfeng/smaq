...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl" style="display: block;">
      <label class="form-label col-xs-4 col-sm-2">车间：</label>
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="part" value="${parName}" style="width:350px" class="input-text required" maxlength="50"/>
      </div> 
    </div>
