    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
        ...
        <!--组织架构-->
            <ul>
                <li><a href="${ly }/global/conrespond?userId=${userId}" data-title="应急响应" href="javascript:void(0)">应急响应</a></li>
                <li><a href="#" data-title="直击现场" href="javascript:void(0)">直击现场</a>
                <li><a href="${ly }/village/to_monitor-list?flag=1&userId=${userId}" data-title="实时监控" href="javascript:void(0)">实时监控</a>
                <li><a href="#" data-title="应急管理" href="javascript:void(0)">应急管理</a>
                <li><a href="${ly }/global/threeLeft?leftBasic=11" data-title="在线监测" href="javascript:void(0)">在线监测</a>
            </li>
            </ul>
        </div>
        </body>
