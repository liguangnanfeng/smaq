...
<body>
  ...
  <div class="tabBar clearfix">
    <a class="current" style="border-radius:5px 0 0 5px;" href="${ly}/company/evaluate/detection-list?isTime=${isTime}">职业卫生检测</a>
    <a style="border-radius:0 5px 5px 0;" href="${ly}/company/warning/examination-list?isTime=${isTime}">职业健康体检</a>
  </div>
    <div class="page-container">
      <div class="text-c">
        <form action="${ly}/company/evaluate/detection-list" method="post">
          <div class="dis-ib">
            <span>检测类别：</span>
      ...
      <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
          <a class="btn btn-primary radius" data-title="职业卫生检测-添加" data-href="${ly }/company/evaluate/detection-edit" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加职业卫生检测</a>
        </span>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
          ...
          <tbody>
            ...
            <tr class="text-c">
              ...
              <td style="display:none">${de.jcd}</td>
              <td>${de.whys}</td>
              <td>${de.jcjg}</td>
              <td>${de.jcdw}</td>
              <td>${de.jcbh}</td>
              ...
              <td>${de.remark}</td>
              <td>
                <a style="text-decoration:none" href="javascript:void(0)" onclick="top.show_tab('职业卫生检测-编辑', '/company/evaluate/detection-edit?id=${de.id}')" title="编辑">编辑</a>
...
function del_(id) {
  $.post("/company/evaluate/deleteDe", {
    id : id
  },function(result) {
    location.reload();
  })
