...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    ...
    <div class="row cl mt-20">
      <label class="form-label col-xs-4 col-sm-2">企业搜索：</label>
    ...
    <div class="row cl">
      <label class="form-label col-xs-4 col-sm-2">确定企业：</label>
...
function article_save_submit() {
  ...
  window.location.href = getRootPath() + "/global/conManager?userId=" + $(":radio:checked").val();
}
</script>
</html>