...
<div class="select-btn">
        <a class="sbtn" id="chaBtn1"  href="${ly }/global/yh-analysis?flag=1">企业自查</a>
        <a class="sbtn" id="chaBtn2" href="${ly }/global/yh-analysis?flag=2">行政检查</a>
        <a class="sbtn" id="chaBtn3" href="${ly }/global/yh-analysis?flag=3">第三方检查</a>
</div>
...
<script>
        ...
        if('${flag}'==1){
                ...
                url='${ly }/global/zhuChartData22?flag=1';
        }
        if('${flag}'==2){
                $("#chaBtn2").addClass('btn-default');
                url='${ly }/global/zhuChartData22?flag=2';
        }
        if('${flag}'==3){
                $("#chaBtn3").addClass('btn-default');
                url='${ly }/global/zhuChartData22?flag=3';
        }
        function addgjs() {
                show_dialog(" ", "/global/yh-analysis?flag=1");
        }
...
<script type="text/javascript">
        // 基于准备好的dom，初始化echarts实例
        var url3 = '${ly }/global/zhuChartData77';
