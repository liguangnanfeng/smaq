  <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
    ...
    <div class="menu_dropdown bk_2">
      ...
      <dl>
        ...
        <dd>
            <ul>
                <li><a data-href="${ly }/company/threeLeft?leftBasic=5" data-title="体系管理" href="javascript:void(0)">体系管理</a></li>
       ...
       <ul>
           ...
           <li><a data-href="${ly }/company/source/model-list-cx" data-title="隐患排查" href="javascript:void(0)">隐患排查</a></li>
