  ...
  <div class="page-container">
    ...
    <c:if test="${flag == 1 }">
      <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;margin-top:20px;">
        <a class="btn default ${flag == 1&&template==1 ? 'btn-primary' : 'radius'}" href="${ly }/company/model-list-cx?flag=1&type=1&template=1">检查实施</a>
		<c:if test="${rjcbxs == 1 }">
            ...
            <div class="modal-content radius">
                ...
                <div class="modal-body">
                   <div class="list_jian list_zi">
                     <a class="btn_jian btn_an1" data-dismiss="modal" aria-hidden="true" data-title="企业自查-检查实施" data-href="${ly }/company/model-add?type=1&flag=1" onclick="Hui_admin_tab(this)" href="javascript:;">
                       <span>
