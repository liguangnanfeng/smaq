...
<body>
  ...
  <div class="tabBar clearfix">
    <a style="border-radius:5px 0 0 5px;" href="${ly}/global/warning/detection-list?isTime=${isTime}">职业卫生检测</a>
    <a class="current" style="border-radius:0 5px 5px 0;" href="javascript:void(0)">职业健康体检</a>
  </div>
    <div class="page-container">
      <div class="text-c">
        <form action="${ly}/global/warning/examination-list" method="post">
          <div class="dis-ib">
            <span>所属企业：</span>
