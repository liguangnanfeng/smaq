        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort mb-40">
            <tr>
                <td>
                    <div class="list-dbz">
                        <p>
                            1.安全风险从高到低依次对应为红色、橙色、黄色、蓝色。总分在90分以上（含90分）的为蓝色；75分（含75分）至90分的为黄色；60分（含60分）至75分的为橙色；60分以下的为红色。</p>
        ...
        <div class="mt-20 f-l" style="width:100%">
            <table class="table table-border table-bordered table-bg table-hover table-sort tab-ndan">
                ...
                <tr>
                    ...
                    <td rowspan="4"><input type="text" value="" data-idx="0" class="input-dan ll-numberbox"
                                           data-options="min:0,max:10" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <!-- type 1 扣分 2加分 -->
                    <td><input type="text" value="" data-idx="1" class="input-dan ll-numberbox"
                               data-options="min:0,max:5" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="1" class="input-dan ll-numberbox"
                               data-options="min:0.0,max:5,precision:1" data-type="1"/></td>
                </tr>
                <tr>
                    <td class="text-c">危险化工工艺种类（10分）</td>
                    <td><p>涉及18种危险化工工艺的，每一种扣2分。</p></td>
                    <td><input type="text" value="" data-idx="2" class="input-dan ll-numberbox"
                               data-options="min:0,max:10,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                    <td class="text-c" rowspan="2">火灾爆炸危险性（5分）</td>
                    <td><p>涉及甲类/乙类火灾危险性类别厂房、库房或者罐区的，每涉及一处扣1/0.5分</p></td>
                    <td><input type="text" value="" data-idx="3" class="input-dan ll-numberbox"
                               data-options="min:0,max:5,precision:1" data-type="1"/></td>
                </tr>
                <tr>
                    <td><p>涉及甲类、乙类火灾危险性罐区、气柜与加热炉等与产生明火的设施、装置比邻布置的，扣5分。</p></td>
                    <td><input type="text" value="" data-idx="3" class="input-dan ll-numberbox"
                               data-options="min:0,max:5,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                    <td rowspan="2" class="text-c">2.周边环境</td>
                    <td rowspan="2" class="text-c">周边环境（10分）</td>
                    <td><p>企业在化工园区（化工集中区）外的，扣3分；</p></td>
                    <td><input type="text" value="" data-idx="4" class="input-dan ll-numberbox"
                               data-options="min:0,max:10,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="5" class="input-dan ll-numberbox"
                               data-options="min:0,max:10,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="5" class="input-dan ll-numberbox"
                               data-options="min:0,max:2,precision:0" data-type="2"/></td>
                </tr>
                <tr>
                    <td class="text-c" rowspan="3">4.设备</td>
                    <td class="text-c" rowspan="3">设备（5分）</td>
                    <td><p>使用淘汰落后安全技术工艺、设备目录列出的工艺及设备的，每一项扣2分；</p></td>
                    <td><input type="text" value="" data-idx="6" class="input-dan ll-numberbox"
                               data-options="min:0,max:5,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="7" class="input-dan ll-numberbox"
                               data-options="min:0,max:10,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="8" class="input-dan ll-numberbox"
                               data-options="min:0,max:15,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="8" class="input-dan ll-numberbox"
                               data-options="min:0,max:3,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;"><p>企业主要负责人、分管安全生产工作负责人、安全管理部门主要负责人为化学化工类专业毕业的，每一人次加2分。</p></td>
                    <td><input type="text" value="" data-idx="8" class="input-dan ll-numberbox"
                               data-options="min:0,precision:0" data-type="2"/></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="9" class="input-dan ll-numberbox"
                               data-options="min:0,max:5,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="10" class="input-dan ll-numberbox"
                               data-options="min:0,max:3,precision:0" data-type="2"/></td>
                </tr>
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="10" class="input-dan ll-numberbox"
                               data-options="min:0,max:15,precision:0" data-type="2"/></td>
                </tr>
                <tr>
                    <td style="font-weight:bold;"><p>安全生产标准化为二级的，加5分；</p></td>
                    <td><input type="text" value="" data-idx="11" class="input-dan ll-numberbox"
                               data-options="min:0,max:5,precision:0" data-type="2"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td><input type="text" value="" data-idx="11" class="input-dan ll-numberbox"
                               data-options="min:0,max:8,precision:0" data-type="1"/></td>
                </tr>
                <tr>
                ...
                <tr>
                    <td colspan="3" style="font-weight:bold;"><p>
                        三年内发生过重大以上安全事故的，或者三年内发生2起较大安全事故，或者近一年内发生2起以上亡人一般安全事故的。</p></td>
