...
<nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>${flag!=2 ? '隐患排查治理系统' : '行政执法检查'}</span>
    <c:if test="${flag != 2}">
                ...
                <tr class="text-c">
                    ...
                    <td>
                        ...
                        <a style="text-decoration:none"
                           onClick="show_dialog('检查详情_${be.id }', '${ly}/global/check-detail?flag=${flag }&id=${be.id }&number=${be.c}&uid=${uid}')"
                           href="javascript:;">检查详情</a><br>
                        <c:if test="${be.listM.c3 > 0}">
                            <a style="text-decoration:none"
                               onClick="location.href = '/global/fuchadetail?checkId=${be.id}&flag=${flag}&number=${be.c }&uid=${uid}'"
                               href="javascript:;">复查详情</a><br>
                        </c:if>

                        <c:if test="${flag!=1}">
                            <a style="text-decoration:none"
                               onClick="location.href = '/global/check-document?checkId=${be.id}&uid=${uid}'" href="javascript:;">文书详情</a><br>
                        </c:if>
