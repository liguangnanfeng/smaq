...
<body>
  ...
  <div class="tabBar clearfix">
    <a style="border-radius:5px 0 0 5px;" href="${ly}/company/evaluate/detection-list?isTime=${isTime}">职业卫生检测</a>
    <a class="current" style="border-radius:0 5px 5px 0;" href="${ly}/company/warning/examination-list?isTime=${isTime}">职业健康体检</a>
  </div>
    <div class="page-container">
      <div class="text-c">
        <form action="${ly}/company/warning/examination-list" method="post">
          <div class="dis-ib">
            <span>所属企业：</span>
      ...
      <div class="cl pd-5 bg-1 bk-gray mt-20">
        <span class="l">
          <a class="btn btn-primary radius" data-title="职业健康体检-添加" data-href="${ly }/company/evaluate/health-edit" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加职业健康体检</a>
        </span>
        ...
        <table class="table table-border table-bordered table-bg table-hover table-sort">
          ...
          <tbody>
            ...
            <tr class="text-c">
                <td>${index.index+1 }</td>
                <td>${de.type }</td>
                <td style="display:none">${de.project }</td>
                <td>${de.whys }</td>
                <td>${de.time }</td>
                ...
                <td>${de.remark }</td>
                 <td>
                  <a style="text-decoration:none" href="javascript:void(0)" onclick="top.show_tab('职业健康体检-编辑', '/company/evaluate/health-edit?id=${de.id}')" title="编辑">编辑</a>
