...
<body>
  ...
  <div class="page-container">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('编辑生产工艺流程图','${ly }/company/process/process-edit')" <%-- data-title="编辑生产工艺流程图" data-href="${ly }/company/process/process-edit" onclick="Hui_admin_tab(this)" href="javascript:;" --%>><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加生产工艺流程图</a>
      </span>
...
/*删除*/
function del(id){
  $.post(getRootPath() + "/company/process/process-del", {
	   id: id,
	}, function(reuslt) {
	    location.reload()
	})
