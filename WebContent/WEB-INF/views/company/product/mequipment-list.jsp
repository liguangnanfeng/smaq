...
<body>
  ...
  <span class="c-gray en">&gt;</span><span>设备设施管理</span>
    <span class="c-gray en">&gt;</span> <span>主要设备清单</span> 
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/company/product/mequipment-list" method="post">
        <div class="dis-ib">
          <span>名称：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" data-title="添加主要设备" data-href="${ly }/company/product/mequipment-add" onclick="Hui_admin_tab(this)" href="javascript:;"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加主要设备</a>
      ...
      <table class="table table-border table-bordered table-bg table-hover table-sort">
        ...
        <tbody>
          ...
          <tr class="text-c">
            ...
            <td>${equip.remark }</td>
            <td>
              <a style="text-decoration:none" onClick="show_tab('编辑主要设备', '${ly }/company/product/mequipment-edit?id=${equip.id}')" href="javascript:;" title="编辑">查看/编辑</a>
  ...
  <div id="majorequipmentImportBox" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
       <div class="modal-dialog">
        ...
        <div class="modal-body" id="importBox">
               ...
               <div class="modal-footer">
                   <button class="btn btn-primary" onclick="majorequipmentImportSave()">保存</button>
...
/*删除*/
function del(id){
  $.post(getRootPath()+"/company/product/deleteEquipment",{
    id:id,
  },function(reuslt){
    location.reload()
  })
...
function print_() {
  ...
  show_dialog("主要设备", getRootPath() + "/company/product/mequipment-list-print?" + obj);
}
</script> 
</body>
</html>