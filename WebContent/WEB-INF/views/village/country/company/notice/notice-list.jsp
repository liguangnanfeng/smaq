...
<body>
  <div class="page-container">
    ...
    <div class="div_fal">
        <div class="div_tifa"><font>/ 监管动态</font><bb>&nbsp;</bb></div>
    ...
    if(list.length > 2) {
      laypage({
        ...
        jump: function(obj){ //触发分页后的回调
          var page = obj.curr;
          var i = (page - 1) * rows;
          p.find(".one_notice:visible").hide();
          var end = rows + i;
...
function admin_show(id){
  show_tab("公告详情", getRootPath() + "/fore/notice-show?id=" + id + "&type=1");
}
