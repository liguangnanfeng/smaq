...
<div class="page-container">
  <form class="form form-horizontal" id="form">
    <div class="row cl">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <!--<input type="text" id="name" value="${m.name }" style="width:350px" class="input-text required"  >-->
      	<input type="text" id="name" value="${camera}" style="width:350px" readonly="readonly" class="input-text required"  ><!--zhangcl 2018.12.26-->
      </div> 
    </div>
    ...
    <div class="row cl" style="display:none;">
      ...
      <div class="formControls col-xs-8 col-sm-9">
        <input type="text" id="thumbnail_val" disabled  value="${m.thumbnail }" style="width:300px;margin-top: -24px;" class="input-text required" ><a href="javascript:void(0);" id="to_uploader">上传</a>
