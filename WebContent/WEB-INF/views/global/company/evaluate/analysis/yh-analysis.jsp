    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <a class="sbtn" id="chaBtn1"  href="${ly }/global/yh-all-analysis?flag=1">企业自查</a>
        <a class="sbtn" id="chaBtn2" href="${ly }/global/yh-all-analysis?flag=2">行政检查</a>
        <a class="sbtn" id="chaBtn3" href="${ly }/global/yh-all-analysis?flag=3">第三方检查</a>
        </div>
        ...
        <div class="select-btn">
        <a class="sbtn" id="chaBtn11"  href="${ly }/global/yh-all-analysis?sign=1">企业自查</a>
        <a class="sbtn" id="chaBtn22" href="${ly }/global/yh-all-analysis?sign=2">行政检查</a>
        <a class="sbtn" id="chaBtn33" href="${ly }/global/yh-all-analysis?sign=3">第三方检查</a>
        </div>
        ...
        url2= "${ly }/global/zf-hidden-trouble?sign=1"
        }
        if('${sign}'==2){
        $("#chaBtn22").addClass('btn-default');
        url2="${ly }/global/zf-hidden-trouble?sign=2"
        }
        if('${sign}'==3){
        $("#chaBtn33").addClass('btn-default');
        url2="${ly }/global/zf-hidden-trouble?sign=3"
        }
        ...
        xAxis: {
        type: 'category',
        data: ["设计总图", "试生产", "装置运行", "设备安全", "仪表安全", "电气安全", "应急消防", "特殊管控", "行为环境", "生产现场", "公辅工程", "特种设备", "专项行业",
