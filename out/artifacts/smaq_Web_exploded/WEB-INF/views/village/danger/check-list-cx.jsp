...
function l_(t) {
  ...
  if(t == 2) {
    if(flag_ == 2) { show_dialog('行政执法-添加现场检查记录', '/village/danger/opinion-add?flag=8&flag2=2&userId=');}
    if(flag_ == 3) { show_dialog('部门抽查-添加现场检查记录', '/village/danger/opinion-add?flag=8&flag2=3&userId=');}
    if(flag_ == 4) { show_dialog('行政检查-添加现场检查记录', '/village/danger/opinion-add?flag=8&flag2=4&userId=');}
  }
}
