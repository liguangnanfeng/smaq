...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>检查表设置</span> 
  ...
  <div class="page-container">
    ...
    <c:if test="${flag == 4}">
        <div class="div_bgrou">
        <font class="font_rou">行政检查</font>
        <div class="list_jian">
           <a class="btn_jian btn_an3"  href="javascript:void(0)" onclick="show_dialog('行政检查-标准检查','${ly }/village/check-add?flag=4')">
             <span>
               <img alt="" src="${ly }/images/b1wxz.png" class="wxz"/>
               <img alt="" src="${ly }/images/b1xz.png" class="xz"/>
             </span> 
           ...
           <a class="btn_jian btn_an4" href="javascript:void(0)" onclick="show_dialog('行政检查-自定义检查', '${ly }/village/danger/opinion-add?flag=8&flag2=4')">
             <span>
               <img alt="" src="${ly }/images/b2wxz.png" class="wxz"/>
               <img alt="" src="${ly }/images/b2xz.png" class="xz"/>
             </span> 
  ...
  <%-- <c:if test="${flag != 2}">
    <c:if test="${session_user.userType == 3 || session_user.userType == 4 || session_user.userType == 9 || session_user.userType == 10}">
      <div class="div_bgrou">
        <font class="font_rou">行政检查</font>
        <div class="list_jian">
           <a class="btn_jian btn_an3"  href="javascript:void(0)" onclick="show_dialog('行政检查-标准工具检查','${ly }/village/check-add?flag=4')">
             <span>
               <img alt="" src="${ly }/images/b1wxz.png" class="wxz"/>
               <img alt="" src="${ly }/images/b1xz.png" class="xz"/>
             </span> 
           ...
           <a class="btn_jian btn_an4" href="javascript:void(0)" onclick="show_dialog('行政检查-自定义文书检查', '${ly }/village/danger/opinion-add?flag=8&flag2=4')">
             <span>
               <img alt="" src="${ly }/images/b2wxz.png" class="wxz"/>
               <img alt="" src="${ly }/images/b2xz.png" class="xz"/>
             </span> 
    ...
    <div class="div_bgrou" style="border:0px;">
      <font class="font_rou">部门抽查</font>
      <div class="list_jian">
         <a class="btn_jian btn_an3" href="javascript:void(0)" onclick="show_dialog('部门抽查-标准工具检查', '${ly }/village/check-add?flag=3')">
           <span>
             <img alt="" src="${ly }/images/b1wxz.png" class="wxz"/>
             <img alt="" src="${ly }/images/b1xz.png" class="xz"/>
           </span> 
         ...
         <a class="btn_jian btn_an4" href="javascript:void(0)" onclick="show_dialog('部门抽查-自定义文书检查', '${ly }/village/danger/opinion-add?flag=8&flag2=3')">
           <span>
             <img alt="" src="${ly }/images/b2wxz.png" class="wxz"/>
             <img alt="" src="${ly }/images/b2xz.png" class="xz"/>
           </span> 
