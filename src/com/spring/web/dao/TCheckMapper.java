...
public interface TCheckMapper {
    ...
    Integer findCountAll2(@Param("depart")String depart, @Param("user_ids")String user_ids);
    ...
    Integer findDataCountsByCliqu(@Param("user_id")String user_id,@Param("flag")Integer flag);

    Integer findDataCountSum(@Param("user_id")Integer user_id,@Param("status")Integer status,@Param("flag")Integer flag);

    Integer findDataCountSumByCliqu(@Param("user_id")String user_id,@Param("status")Integer status,@Param("flag")Integer flag);
