...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>高危隐患企业列表</span> 
...
<script type="text/javascript" src="${ly }/js/modules/newWarn/gwCompanyList.js"></script>
...
{@each list as m,index}
    <tr class="text-c">
          ...
          <td>$<{m.companyName}></td>
          <td>$<{m.warnCount}></td>
          <td><a class=""  data-title="$<{m.companyName}>高危作业" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="${ly }/village/company/gwlist?from=1&companyId=$<{m.companyId}>">查看详情</a></td>
     </tr>
{@/each}
</script>
</body>
