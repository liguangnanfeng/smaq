    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <a class="sbtn" onclick="tz('#chaBtn1')" id="chaBtn1"  href="${ly }/global/zf-hidden-industry?flag=1">企业自查</a>
        <a class="sbtn" onclick="tz('#chaBtn2')" id="chaBtn2" href="${ly }/global/zf-hidden-industry?flag=2">行政检查</a>
        <a class="sbtn" onclick="tz('#chaBtn3')" id="chaBtn3" href="${ly }/global/zf-hidden-industry?flag=3">第三方检查</a>
        </div>
        ...
        <a class="sbtn" onclick="tz('#chaBtn11')"  id="chaBtn11"  href="${ly }/global/zf-hidden-trouble?flag=1">企业自查</a>
        <a class="sbtn" onclick="tz('#chaBtn22')" id="chaBtn22" href="${ly }/global/zf-hidden-trouble?flag=2">行政检查</a>
        <a class="sbtn" onclick="tz('#chaBtn33')" id="chaBtn33" href="${ly }/global/zf-hidden-trouble?flag=3">第三方检查</a>
        </div>
