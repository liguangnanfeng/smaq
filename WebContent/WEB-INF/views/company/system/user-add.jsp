...
<%--        <div class="formControls col-xs-8 col-sm-9">--%>
<%--            <span class="select-box inline">--%>
<%--              &lt;%&ndash;  <label><input type="radio"/>无</label>--%>
<%--                <label><input type="radio"/>安全检查员</label>--%>
<%--                <label><input type="radio"/>安全责任人</label>&ndash;%&gt;--%>
<%--                   <select name="statusId" class="select" id="statusId" value="${user.status}" >--%>
<%--                    <option value="0">请选择</option>--%>
<%--                    <option value="1">安全检查员</option>--%>
<%--                    <option value="2">安全责任人</option>--%>
<%--                  </select>--%>
...
<%--    <div class="formControls col-xs-8 col-sm-9">--%>
<%--    <span class="select-box inline">--%>
<%--    <select name="ss" class="select" id="statusId" value="" >--%>
<%--    <option value="0">请选择</option>--%>
<%--    <option value="1">三级</option>--%>
<%--    <option value="2">四新</option>--%>
...
<%--    <div class="formControls col-xs-8 col-sm-9">--%>
<%--    <span class="select-box inline">--%>
<%--    <select name="ss2" class="select" id="statusId" value="" >--%>
<%--    <option value="0">请选择</option>--%>
<%--    <option value="1">是</option>--%>
<%--    <option value="2">否</option>--%>
<%--    </select>--%>
...
<%--    console.log($("select[name='statusId'] option:selected").text());--%>
<%--    console.log($("select[name='ss'] option:selected").text());--%>
<%--    console.log($("select[name='ss2'] option:selected").text());--%>
<%--    let statusId=$("select[name='statusId'] option:selected").text();--%>
<%--    let ss=$("select[name='ss'] option:selected").text();--%>
<%--    let ss2=$("select[name='ss2'] option:selected").text();--%>
<%--    let tz=$("#pwd").val();--%>
<%--    console.log('ts---',tz);--%>
<%--        if($("#addpw").val()){--%>
<%--            user = {--%>
