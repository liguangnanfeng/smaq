  ...
  var info = {
      ...
      initList : function(){
        ...
        $("#toSearchGroupName").unbind("click").bind("click",function(){
          ...
          location.href = rootPath+"/global/groupIndex?groupName="+searchGroupName;
        });
        ...
        $(".toedit").unbind("click").bind("click",function(){
          var groupId = $(this).attr("core-id");
          location.href=rootPath+"/global/tpAddGroup?groupId="+groupId;
        });
      ...
      editGetList : function(groupId){
        $.ajax({
          url : rootPath + "/global/getGroupDetail",
          type : 'post',
          data : {
            groupId : groupId
          },
        ...
        $.ajax({
          ...
          success : function(data){
            if(data.status){
              layer.msg("添加成功");
              setTimeout(function(){
                location.href=rootPath + "/global/groupIndex";
              },1500)
            }
          }
        });
