...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/tradeclique/product/material-list" method="post">
        <div class="dis-ib">
          <span>原辅材料名称：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('添加主要原辅材料','${ly }/tradeclique/product/material-add')"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加主要原辅材料</a>
      </span>
...
function admin_edit(id){
  show_tab("编辑主要原辅材料", getRootPath() + "/tradeclique/product/material-edit?id=" + id);
}

/*删除*/
function del(id){
  $.post(getRootPath()+"/tradeclique/product/deleteMaterial",{
    id:id,
  },function(reuslt){
    location.reload()
  })
