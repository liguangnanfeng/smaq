            ...
            <div class="mt-20">
                <table class="table table-border table-bordered table-bg table-hover table-sort tab-ndan"  >
                    ...
                    <tr class="text-c">
                        ...
                        <th style="width:8%">项目（分值）</th>
                        <th style="width:8%">评估内容</th>
                        <th style="width:8%">扣分值</th>
                ...
                <table class="table table-border table-bordered table-bg table-hover table-sort tab-ndan"  >
                    ...
                    <tr>
                        <td colspan="2">备注： 1.安全风险从高到低依次对应为红色、橙色、黄色、蓝色。总分在90分以上（含90分）的为蓝色；75分（含75分）至90分的为黄色；60分（含60分）至75分的为橙色；60分以下的为红色。
                            2.每个项目分值扣完为止，最低为0分。
                            3.储存企业指带储存的经营企业。
                        </td>
