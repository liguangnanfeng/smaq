...
<body>
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/tradeclique/process/process-list" method="post">
        <div class="dis-ib">
          <span>项目名称：</span>
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      <span class="l">
        <a class="btn btn-primary radius" href="javascript:show_dialog('编辑生产工艺流程图','${ly }/tradeclique/process/process-edit')"><i class="Hui-iconfont" style="font-size:15px;">&#xe600;</i> 添加生产工艺流程图</a>
      </span>
...
function admin_edit(id){
  show_tab("编辑生产工艺流程图", getRootPath() + "/tradeclique/process/process-edit?id=" + id);
}

/*删除*/
function del(id){
  $.post(getRootPath() + "/tradeclique/process/process-del", {
	   id: id,
	}, function(reuslt) {
	    location.reload()
	})
