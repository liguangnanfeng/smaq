...
<c:set var="zdsgyh" value="${d1_2 + d2_2 + d3_2 + d4_2}"/>
  ...
  <a class="one_tx radius pos-r" data-title="隐患治理" data-href="/steel/hidden-danger-list?flag=1&status=1&&breaken=2"  onclick="Hui_admin_tab(this)" style="background:#ea4f21;margin-right:2%">
  <img alt="" src="${ly }/images/httb9.png"/>
  ...
  <a class="one_tx radius pos-r" data-title="重大隐患" href="javascript:;"   data-href="${ly }/steel/check-item32?status=2" onclick="Hui_admin_tab(this)" style="background:#ea4f21;margin-right:0">
  <img alt="" src="${ly }/images/httb9.png"/>
