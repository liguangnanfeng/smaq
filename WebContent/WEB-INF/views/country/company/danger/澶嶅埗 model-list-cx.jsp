        ...
        <tbody>
          ...
          <c:forEach items="${list }" varStatus="index" var="be">
            ...
            <td>
              ...
              <c:if test="${flag == 1}">
              <a style="text-decoration:none" onClick="show_dialog('检查详情_11e1e${be.id }', '${ly}/company/check-detail?flag=${flag }&id=${be.id }')" href="javascript:;">查看检查记录</a>
              </c:if>
              <c:if test="${flag == 4 || flag == 3}">
              <a style="text-decoration:none" onClick="show_dialog('检查详情_1q1q1q1${be.id }', '${ly}/village/check-document?checkId=${be.id }&flag=8')" href="javascript:;">查看检查记录</a>
              </c:if>
