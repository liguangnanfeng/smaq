...
<body>
    <div class="page-container" style="width:250mm;margin:auto;padding:10px 0 0 0;">
        ...
        <p class="MsoNormal" style="text-align:right;margin-bottom:15px;border-top:1px solid #000;padding-top:10px;" align="right">
            <span style="font-size:12pt;"><span>检查日期</span><span contenteditable="true" style="text-decoration:underline;">&nbsp;<fmt:formatDate value="${timenow }" pattern="yyyy"/>&nbsp;</span><span>年</span><span contenteditable="true" style="text-decoration:underline;">&nbsp;<fmt:formatDate value="${timenow }" pattern="MM"/>&nbsp;</span><span>月</span><span contenteditable="true" style="text-decoration:underline;">&nbsp;<fmt:formatDate value="${timenow }" pattern="dd"/>&nbsp;</span><span>&nbsp;日&nbsp;</span></span>
        </p>
        <p class="MsoNormal">
            <u><span style="float:left;">受检单位</span><span style="float:left;text-decoration:underline;" contenteditable="true">&nbsp;&nbsp;&nbsp;${company.name }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span></u><span style=""><span>：</span></span><span style=""></span>
        </p>
            ...
            <div class="formControls col-sm-2" style="width: 80%">
                ...
                <c:forEach items="${itemL }" var="be" varStatus="index">
                  <div class="check-box">
                    <input type="checkbox" name="isxian" data-i="${be.id }" data-file="" data-status="2"
                      data-dead="<fmt:formatDate value="${be.deadline }" pattern="yyyy-MM-dd"/>" /> <label>${index.index + 1}</label>
                  </div>
                </c:forEach>
                <!-- 循环结束 -->
              </div>
              <div class="div_pri  mb-10  mt-10">
                <font style="float: Left;">2、对未整改项要求于</font> <input type="text" id="nextTime" value=""
                  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd',minDate:'%y-%M-%d'})" class="input-text Wdate" style="float: left; width: 186px;">
