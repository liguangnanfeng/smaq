...
.div_pright{width:380px;display: inline-block;}
...
function uploadpicture(obj,measures){
      ...
      <tbody>
        ...
        <tr>
          ...
          <td class="text-c" data-base="${ch.status }">&nbsp;
            <div class="radio-box">
              <input type="radio" name="plan-radio-${ch.id }" data-part="${part.id }" data-item="${ch.id }" value="1" <c:if test="${ch.status == 1}">checked</c:if>>
              <label>合格</label>
            </div>
            <div class="radio-box">
              <input type="radio" value="2" data-file="" data-part="${part.id }" name="plan-radio-${ch.id }" data-item="${ch.id }" onClick="uploadpicture(this,'${ch.measures}')" <c:if test="${ch.status == 2}">checked</c:if>>
              <label>不合格</label>
            </div>
        ...
        <tr>
          ...
          <div style="float:left;width:100%;min-height:150px;">
            ...
            <div class="div_pright  mt-10 mb-10">
              <input type="text" style="width:150px" id="dapartContact" value="${check.dapartContact }" class="input-text" maxlength="50"/>
            </div>
            </div>
          </td>
        </tr>
