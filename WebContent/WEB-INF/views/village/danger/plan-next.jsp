<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    ...
    <!-- 弹窗图片 -->
    <div id="modal-img" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    aria-hidden="true">
    <div class="modal-dialog">
    <div class="modal-content radius">
    <div class="modal-header">
    ...
    top.show_tab("治理意见表_" + checkId, '/village/check-rectification?flag=' + flag + '&id=' +
    checkId+'&departName=${departName}');
    } else {
