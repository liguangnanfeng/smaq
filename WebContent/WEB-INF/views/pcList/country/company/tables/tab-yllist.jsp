    ...
    <div class="page-container">
        <div class="HuiTab">
            <div class="tabBar clearfix">
                <a href="${ly }/company/tables/tab-yjlist?c=${c}" class="tab" style="border-radius:5px 0 0 5px;">应急预案</a>
                <a class="tab current" href="${ly }/company/tables/tab-yllist?c=${c}" style="border-radius:0 5px 5px 0;">应急预案演练</a>
            </div>
