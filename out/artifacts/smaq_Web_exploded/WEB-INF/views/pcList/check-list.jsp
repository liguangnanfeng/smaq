...
<body>
  ...
  <div class="page-container">
    ...
    <div id="spTab" class="btn-group" style="text-align: center;margin-bottom: 20px;">
        <a class="btn default ${flag == 1 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/check-list?flag=1&status=1&villageId=${villageId }&townId=${townId }&districtId=${districtId }">企业自查</a> 
        <a class="btn default ${flag == 4 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/check-list?flag=4&villageId=${villageId }&townId=${townId }&districtId=${districtId }">行政检查</a>
        <a class="btn default ${flag == 3 ? 'btn-primary' : 'radius'}" href="${ly }/town/cx/check-list?flag=3&villageId=${villageId }&townId=${townId }&districtId=${districtId }">部门抽查</a>
        <%-- <a class="btn default ${flag == 2 ? 'btn-primary' : 'radius'}" href="${ly }/village/check-list?flag=2">执法检查</a> --%>
    </div>
    </c:if>
    <div class="text-c">
      <form action="${ly }/town/cx/check-list?flag=${flag}&villageId=${villageId }&townId=${townId }&districtId=${districtId }" method="post">
        <%-- <c:if test="${session_user.userType == 9}">
            <span>所在镇：</span>
