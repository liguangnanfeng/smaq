...
<%--    <span class="c-gray en">&gt;</span> <span>安全生产标准化--编辑版</span>--%>
...
<script type="text/javascript">
    ...
    function queren() {
        $.ajax({
            url: getRootPath() + "/api/safety_Standard/save-safety",    //请求的url地址 
            data: JSON.stringify({
    ...
    function queren2() {
        $.ajax({
            url: getRootPath() + "/api/safety_Standard/update-tSafety",    //请求的url地址 
