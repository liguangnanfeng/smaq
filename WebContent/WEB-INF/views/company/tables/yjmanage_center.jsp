    ...
    <%--<!DOCTYPE html>--%>
        ...
        <%--font-weight: bold;--%>
        <%--}--%>
            <%--&lt;%&ndash;        background-color: #f95b26;&ndash;%&gt;--%>
            <%--&lt;%&ndash;        background-image: linear-gradient(180deg, #f95b26 10%, #fb801b 100%);&ndash;%&gt;--%>
        <%--.func {--%>
            <%--position: relative;--%>
            <%--display: flex;--%>
            <%--justify-content: center;--%>
...
<%--&lt;%&ndash;            margin-left: 9%;&ndash;%&gt;--%>
        ...
        <%--<main>--%>
            ...
            <%--</script>--%>
            <%--<div class="func">--%>
                <%--<section><a href="/company/threeLeft?leftBasic=16">应急管理</a></section>--%>
                <%--<section><a href="javascript:volid(0)">指挥现场</a></section>--%>
            ...
            <%--&lt;%&ndash;href="/company/threeLeft?leftBasic=11"&ndash;%&gt;--%>
                <%--&lt;%&ndash;href="/village/check-item3?status=2"&ndash;%&gt;--%>
...
<%--&lt;%&ndash;预警动态弹出框&ndash;%&gt;--%>
            ...
            <%--&lt;%&ndash;  onclick="show_dialog('隐患排查', '${ly }/village/check-item3?status=2')"&ndash;%&gt;--%>
            <%--</a>--%>
            ...
            <%--&lt;%&ndash;  onclick="show_dialog('隐患治理', '${ly }/village/check-item3?status=2')"&ndash;%&gt;--%>
            <%--</a>--%>
            ...
            <%--<img alt="" src="${ly }/images/httb4.png"/>--%>
            <%--&lt;%&ndash;  data-href="" onclick="Hui_admin_tab(this)"&ndash;%&gt;--%>
            <%--<font class="font_tx1 pos-a <c:if test="${count[4] >0}">blink</c:if>">${count[4] }</font>--%>
...
<%--&lt;%&ndash;在线监测弹出框&ndash;%&gt;--%>
            ...
            <%--<c:choose>--%>
                ...
                <%--</c:when>--%>
                <%--<c:otherwise>--%>
                    <%--<a class="one_tx radius pos-r aa"  data-title="重点部位关键装置实时监控" onclick="Hui_admin_tab(this)" href="javascript:;" data-href="/village/to_monitor-list" style="background:#1450DD;" >--%>
            ...
            <%--<c:choose>--%>
                ...
                <%--</c:otherwise>--%>
            <%--</c:choose>--%>
            <%--&lt;%&ndash; <a class="one_tx radius pos-r" data-title="河道污染" onclick="Hui_admin_tab(this)" href="javascript:void(0)" data-href="${ly }/village/company/wwlist?danger=1" style="width:100%;margin-right:0;background:#DF3030;">--%>
