    ...
    <div class="panel-body">
      <div class="div_tx">
        ...
        <div class="div_company">
          <p>${c.name }<c:if test="${c.isKey == 1}"><label class="bt_zd">重点企业</label></c:if></p>
          <span>统一社会信用代码：${c.license }</span>
          <span>入驻时间：<fmt:formatDate value="${session_user.createTime }" pattern="yyyy-MM-dd HH:mm:ss"/></span>
          <span>
            <a onclick="show_dialog('企业基本信息', '${ly }/tradeclique/company/basic-information?companyId=${loginUserId}')" href="javascript:;" class="lianj_com"><img alt="" src="${ly }/images/fore/sous.jpg"/>企业基本信息</a>
            &nbsp;&nbsp;&nbsp;
            <a onclick="show_dialog('企业定位', '${ly }/tradeclique/information/information4?companyId=${loginUserId}')" href="javascript:;" class="lianj_com"><img alt="" src="${ly }/images/fore/dt.jpg"/>企业定位</a>
          </span>
        </div>
        <div class="div_company2" style="padding-left:30px;">
          ...
          <span>
            <a data-href="Zheng=2" onclick="show_tab('重点部位关键装置实时监控', '/village/to_monitor-list?flag=2')" href="javascript:;" class="lianj_com"><img alt="" src="${ly }/images/fore/jko.jpg"/>重点部位关键装置实时监控</a>
          </span>
          <span>
            <a data-href="${ly }/tradeclique/tables/tab-yjlist?isTime=6&companyId=${loginUserId}" data-title="应急救援" onclick="Hui_admin_tab(this)" href="javascript:;" class="lianj_com"><img alt="" src="${ly }/images/fore/yj.jpg"/>应急救援</a>
          </span>
        </div>
      </div>
      <div class="mt-15 pos-r">
        <div class="div_tx div_yj" style="padding-top:15px;">
          ...
          <a class="one_tx radius pos-r" data-title="持证上岗" data-href="${ly }/tradeclique/train/special-list?spFlag=0&isTime=3&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="margin-left:1%;background:#46D1E5;">
              ...
              <a class="one_tx radius pos-r" data-title="特种设备检测" data-href="${ly }/tradeclique/sequipment/sequipment-list?isTime=3&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#60D1FF;">
              ...
              <a class="one_tx radius pos-r" data-title="职卫检测、体检" data-href="${ly }/tradeclique/evaluate/detection-list?isTime=3&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#34B5ED;margin-right:0;">
              ...
              <a class="one_tx radius pos-r" data-title="定期检查" data-href="${ly }/tradeclique/tradecheck-list?flag=1&status=1&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#ED6840;">
              ...
              <a class="one_tx radius pos-r" href="javascript:;" onclick="show_dialog('重大事故隐患', '${ly }/tradeclique/check-item3?status=2&companyId=${loginUserId}')"  style="background:#ea4f21;margin-right:0">
           ...
           <%-- <a class="one_tx radius pos-r" id="toOpenDanger"  href="javascript:;"  style="width:100%;margin-right:0;background:#1450DD;">
            ...
            <c:choose>
                <c:when test="${c.hazard eq '1'}">
                  <a class="one_tx radius pos-r"  data-title="重大危险源" onclick="javascript:alert('暂未开通');" href="javascript:;" data-href="${ly }/village/company/zdlist?hazard=1" style="width:100%;margin-right:0;background:#1450DD;" >
                ...
                <c:otherwise>
                  <a class="one_tx radius pos-r"  data-title="重点部位关键装置实时监控" onclick="javascript:alert('暂未开通');" href="javascript:;" data-href="/village/to_monitor-list" style="width:100%;margin-right:0;background:#1450DD;" >
            ...
            <c:choose>
                <c:when test="${c.danger eq '1'}">
                  <a class="one_tx radius pos-r"  data-title="有限（受限）空间作业" onclick="javascript:alert('暂未开通');" href="javascript:;" data-href="${ly }/village/company/gwlist?danger=1" style="width:100%;margin-right:0;background:#1450DD;" >
        ...
        <div class="modal-dialog" style="width:800px">
            <div class="modal-content radius">
                ...
                <div class="modal-body">
                  <a class="one_tx radius pos-r" data-dismiss="modal" aria-hidden="true" data-title="各类评价评估" data-href="${ly }/tradeclique/evaluate/evaluation-list?flag=0&isTime=6&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#FFA160;">
                    <img alt="" src="${ly }/images/httb4.png"/>
                    <font class="font_tx1 pos-a <c:if test="${count[4] >0}">blink</c:if>">${count[4] }</font>
                    <font class="font_tx2 pos-a">评价评估</font>
                  </a>
                  <a class="one_tx radius pos-r" data-dismiss="modal" aria-hidden="true" data-title="各类许可证" data-href="${ly }/tradeclique/evaluate/zheng-list?isTime=6&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="background:#FF9346;">
                  ...
                  <a class="one_tx radius pos-r" data-dismiss="modal" aria-hidden="true" data-title="应急预案" data-href="${ly }/tradeclique/tables/tab-yjlist?isTime=6&companyId=${loginUserId}" onclick="Hui_admin_tab(this)" href="javascript:;" style="margin-right:0;background:#ff8048;">
...
<script type="text/javascript">
var companyId = '${loginUserId}';
</script>
<script type="text/javascript" src="${ly }/js/c-chart-trade.js"></script>
<script type="text/javascript">
