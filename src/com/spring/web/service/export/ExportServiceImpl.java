...
//            }
    ...
    * */
    @Override
    public Result photoImport(MultipartFile file, Integer userId, HttpServletRequest request,String name,String flag) throws Exception {
        Result result = new ResultImpl();
        if (null != file) {
            String fileName = file.getOriginalFilename();
           // 检查扩展名
        ...
        try {
            ...
            importPhoto.setFlag(Integer.parseInt(flag));
