    <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
        ...
        <a class="sbtn" id="chaBtn1"  href="${ly }/steel/yh-analysis?flag=1&userId=${userId}">企业自查</a>
        <a class="sbtn" id="chaBtn2" href="${ly }/steel/yh-analysis?flag=2&userId=${userId}">行政检查</a>
        <a class="sbtn" id="chaBtn3" href="${ly }/steel/yh-analysis?flag=3&userId=${userId}">第三方检查</a>
        </div>
        ...
        <script>
                $(function () {
                        ...
                        $("#selectBranch").change(function () {
                                ...
                                window.location.href="${ly }/steel/yh-analysis?flag=${flag}&userId="+$(this).val();
                        })
                })
        </script>
        <script>
