...
var Map = {
	...
	create:function(container,options){
		...
		map.add_marker = function(options){
			...
			//console.log(offset);
			var mOptions = {position:null,content:options.content,autoRotation:true,extData:options.extData};
	...
	locus:function(opt){
		...
		// 创建起点
		var mOptions = {position:point,content:"测试",autoRotation:true,extData:""};
...
//		
		...
		marker.getExtData = function(){return this.extData};
		marker.setExtData = function(extData){this.extData = extData};
