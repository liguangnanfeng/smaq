...
<body>
  <nav class="breadcrumb">
    ...
    <span class="c-gray en">&gt;</span> <span>较大风险汇总</span> 
  ...
  <div class="page-container">
    <div class="text-c">
      <form action="${ly }/global/safety-system/control-listmenu?level=${m.level }" method="post">
    ...
    <div class="cl pd-5 bg-1 bk-gray mt-20">
      ...
      <span class="r" style="color:#fb6e2a">隐患数量：<strong>${totalyh }</strong> 条</span>
    </div>
    <div class="mt-20">
      <table class="table table-border table-bordered table-bg table-hover table-sort tab-ndan">
        ...
        <tbody>
          ...
          <tr class="text-c">
			...
			<td>
				<form action="${ly }/global/safety-system/control-list?level=${be.level }" method="post">
        			<div class="dis-ib">
