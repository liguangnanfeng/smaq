        ...
        <td valign="middle">
            <div style="float:left;width:100%;">
                <div style="width:1366px;margin:auto;">
                    <div class="div_login">
                        <img alt="" src="${ly }/images/home/sy_title1.jpg" class="img_dlogo"
                             style="max-width: 48%;margin-left: 13%;"/>
            ...
            <div style="float:left;width:100%;background:#1A69DF;margin-top:35px;">
                <div style="width:1366px;margin:auto;">
                    <div class="div_login">
                        <div class="div_lomain">
                            <form class="form form-horizontal" method="post">
                                ...
                                <div class="div_row">
                                    ...
                                    <div class="row_right">
                                        <input id="userName" type="text" placeholder="请输入账户" class="input-text size-L"
                                               required>
                                    </div>
                                </div>
                                <div class="div_row">
                                ...
                                <div class="div_row">
                                    ...
                                    <div class="row_right">
                                        <input id="login_btn" type="button" class="btn btn-success size-L"
                                               style="width:100%;background:#092B5B;border:0px;height:50px;font-size:20px"
                                               value="&nbsp;登&nbsp;&nbsp;&nbsp;&nbsp;录&nbsp;">
                                    </div>
                                </div>
                                <div class="div_row">
                                    ...
                                    <div class="row_right">
                                        ...
                                        <label style="color: white;float:right;" class="forgetpwd"><input id="remember"
                                                                                                          type="checkbox"
                                                                                                          value=""/><b>&nbsp;记住账号</b>
                                        </label>
                        ...
                        <img alt="" src="${ly }/images/xcx.jpg" class="img_dewm" style="width:121px;right:171px">
                ...
                <div style="width:1366px;margin:auto;">
                    <div class="div_login">
                        <div class="div_lomain2">
                            ...
                            <div class="one-f">
                                <font><a
                                        href="http://www.beian.gov.cn/portal/registerSystemInfo?recordcode=32020602000446"
                            ...
                            <div class="one-f">
                                <font size="2"><a href="http://www.miitbeian.gov.cn/"
                                                  target="_blank">苏ICP备17056652号-1</a></font>
                            </div>
                        </div>
                    </div>
                </div>
