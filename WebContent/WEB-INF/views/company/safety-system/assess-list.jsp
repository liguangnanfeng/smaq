...
<body>
  <nav class="breadcrumb text-c">
    ...
    <a class="btn-page"  data-href="${ly }/company/safety-system/assess6"  data-title="较大风险判断" onclick="Hui_admin_tab(this)" href="javascript:;">较大风险判断</a>
    <a class="btn-page pagexz" href="javascript:;">其他风险评估</a>
      ...
      <table class="table table-border table-bordered table-bg table-hover table-sort tab-ass">
        ...
        <tbody>
          ...
          <tr class="text-c">
            ...
            <td>
                <c:choose>
                <c:when test="${be.lev1 eq '红色'}"><font class="col-a">${be.lev1}</font></c:when>
                <c:when test="${be.lev1 eq '橙色'}"><font class="col-b">${be.lev1}</font></c:when>
                <c:when test="${be.lev1 eq '黄色'}"><font class="col-c">${be.lev1}</font></c:when>
                <c:when test="${be.lev1 eq '蓝色'}"><font class="col-d">${be.lev1}</font></c:when>
               </c:choose>
            </td> --%>
            <td>
