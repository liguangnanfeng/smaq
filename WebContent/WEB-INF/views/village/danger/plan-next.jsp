        ...
        <tr>
         ...
         <%-- <td class="text-c" rowspan="${x }" data-partid="${part.id }" data-partimg="${part.partImg }">${part.name }
          ...
          <td class="text-c" data-base="${ch.status }">&nbsp;
            ...
            <div class="radio-box">
              <input type="radio" value="2" data-file="" data-part="${part.id }" name="plan-radio-${ch.id }" data-item="${ch.id }" onClick="uploadpicture(this)" <c:if test="${ch.status == 2}">checked</c:if>>
              <label>不合格</label>
            </div>
