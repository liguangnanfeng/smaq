...
var rootPath = getRootPath();
  ...
  var info = {
      ...
      getCompanyList : function(page,limit,companyName){
        $.ajax({
          url : rootPath + "/village/company/getWaterWarnCompanyList",
          type : 'post',
          data : {
            page : page,
            limit : limit,
          ...
          success : function(data){
            if(undefined != data.list && data.list.length > 0){
              ...
              $("#showTotal").html(0);
              $("#showListBody").html('<tr class="text-c"><td colspan="4">暂无河道污染企业</td></tr>');
            }
